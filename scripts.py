...
# count_ = 1
# for card in wct06:
#     if Counter(wct06)[card] == 1:
#         print('#define CARD_NUMBER_' + re.sub(r'\W+', '_', card.upper()) + ' ' + str(count))
#         count_ = 1
#     else:
#        print('#define CARD_NUMBER_' + re.sub(r'\W+', '_', card.upper()) + '_' + str(count_) + ' ' + str(count))
#        count_ += 1
#     count += 1
...
# for card_index in range(len(data.cards.stats)):
#     if Counter(wct06)[data.cards.stats[card_index].card] == 1:
#         output.write('\t[CARD_NUMBER_' + re.sub(r'\W+', '_', data.cards.stats[card_index].card.upper()))
#         count = 1
#     else:
#         output.write('\t[CARD_NUMBER_' + re.sub(r'\W+', '_', data.cards.stats[card_index].card.upper()) + '_' + str(count)) 
#         count += 1
#     output.write('] =\n\t{\n\t\t.card = CARD_' + re.sub(r'\W+', '_', data.cards.stats[card_index].card.upper()) + ',\n\t\t.artwork = ' + str(data.cards.stats[card_index].artwork) + ',\n\t\t.editedArtwork = ' + str(data.cards.stats[card_index].editedartwork) + ',\n\t\t.attack = ' + str(data.cards.stats[card_index].attack) + ',\n\t\t.defense = ' + str(data.cards.stats[card_index].defense) + ',\n\t\t.level = ' + str(data.cards.stats[card_index].level) + ',\n\t\t.race = RACE_' + re.sub(r'\W+', '_', data.cards.stats[card_index].race.upper()) + ',\n\t\t.attribute = ATTRIBUTE_' + data.cards.stats[card_index].attribute.upper() + ',\n\t\t.cardType = CARD_TYPE_' + re.sub(r'\W+', '_', data.cards.stats[card_index].type.upper()) + ',\n\t\t.spellTrapType = SPELL_TYPE_' + re.sub(r'\W+', '_', data.cards.stats[card_index].spelltype.upper()) + '\n\t},\n')
# output.close()
...
card_descriptions = [
    ...
    '''This legendary dragon is a powerful engine of destruction. Virtually invincible, very few have faced this awesome creature and lived to tell the tale.''',
    '''This legendary dragon is a powerful engine of destruction. Virtually invincible, very few have faced this awesome creature and lived to tell the tale.''',
    '''A delicate elf that lacks offense, but has a terrific defense backed by mistical power.''',
    ...
    '''When you have @5"Right Leg of the Forbidden One"@7, @5"Left Leg of the Forbidden One"@7, @5"Right Arm of the Forbidden One"@7 and @5"Left Arm of the Forbidden One"@7 in addition to this card in your hand, you win the Duel.''',
    ...
    '''@5"Skull Servant"@7 + @5"Battle Warrior"@7''',
    ...
    '''@5"Gaia The Fierce Knight"@7 + @5"Curse of Dragon"@7''',
    ...
    '''@5"M-Warrior #1"@7 + @5"M-Warrior #2"@7''',
    ...
    '''This monster cannot be Normal Summoned or Set. This card can only be Special Summoned by offering @5"Petit Moth"@7 as a Tribute on the 2nd of your turns after @5"Petit Moth"@7 has been equipped with @5"Cocoon of Evolution"@7.''',
    '''This monster cannot be Normal Summoned or Set. This card can only be Special Summoned by Tributing @5"Petit Moth"@7 on the 4th of your turns after @5"Petit Moth"@7 has been equipped with @5"Cocoon of Evolution"@7.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card can only be Special Summoned by the effect of @5"Elegant Egotist"@7.''',
    ...
    '''This card cannot be Normal Summoned or Set. This monster can only be Special Summoned by Tributing @5"Petit Moth"@7 on the 6th of your turns after @5"Petit Moth"@7 has been equipped with @5"Cocoon of Evolution"@7.''',
    '''@5"Time Wizard"@7 + @5"Baby Dragon"@7''',
    '''@5"Time Wizard"@7 + @5"Baby Dragon"@7''',
    ...
    '''You can equip this card from your hand as an Equip Spell Card to a face-up @5"Petit Moth"@7 on the field. If equipped, the ATK and DEF of @5"Cocoon of Evolution"@7 is applied to @5"Petit Moth"@7.''',
    ...
    '''@5"Frenzied Panda"@7 + @5"Ryu-Kishin"@7''',
    ...
    '''@5"Battle Ox"@7 + @5"Mystic Horseman"@7''',
    ...
    '''If @5"Castle of Dark Illusions"@7 is face-up on the field, increase the ATK and DEF of this card by 100 points. As long as this @5"Castle of Dark Illusions"@7 remains face-up on the field, the ATK and DEF of this card continues to increase by 100 points during each of your Standby Phases. This effect continues until your 4th turn after the card is activated.''',
    ...
    '''A wicked mirror that blocks off the damaging effects of an attack.''',
    '''A curtain that a spellcaster made, it is said to raise a dark power.''',
    '''Uses both its physical and shadow forms to attack, making it a difficult monster to overcome.''',
    '''A graveyard that serves as a power source for zombies.''',
    ...
    '''A sword-swinging samurai from the Far East.''',
    '''A monster that feeds on the energy of other creatures.''',
    ...
    '''@5"Mystical Elf"@7 + @5"Curtain of the Dark Ones"@7''',
    ...
    '''A cute little elf that hides in the shadows and provides spiritual support.''',
    ...
    '''A ferocious animal that sleeps all day. Sometimes it's better to let Sleeping Lions lie.''',
    ...
    '''@5"Monster Egg"@7 + @5"Hinotama Soul"@7''',
    '''A mystical chain that binds enemies, rendering them immobile.''',
    ...
    '''A stone warrior with the heart of a dragon.''',
    ...
    '''A very fast, bipedal snail with a pair of lethal arms.''',
    '''This Spellcaster attacks enemies with fire-related spells such as  Sea of Flames and Wall of Fire .''',
    '''One-eyed Necrolancer leads an attack from a dimensional ring that can appear from nowhere.''',
    '''This creature generates gale-force winds and tornadoes to blow its enemies away.''',
    '''An elegant thief with a black cloak that charms its enemies.''',
    '''A mysterious temple of skulls and bones that sucks in unwary enemies.''',
    ...
    '''Armed with the Sword of Crimson Flames, this warrior can bind a monster with fiery restraints.''',
    '''This monster melts away to materialize under its enemies, taking them by surprise.''',
    ...
    '''This creature rolls up its long, snake-like body and uses its beak to attack.''',
    ...
    '''A creature with sapphire eyes that mesmerizes and confuses enemies.''',
    '''A wicked entity that manipulates enemies towards a path of destruction.''',
    ...
    '''@5"Firegrass"@7 + @5"Petit Dragon"@7''',
    ...
    '''This monster bends light to hide its image from the eyes of opponents.''',
    '''A tornado that ravages the wastelands with sharp winds that can cut to the bone.''',
    '''An eye engulfed in flames that flaps its wings to create hot blasts of air.''',
    '''Protected by a spiked shell, this turtle has a very nasty disposition.''',
    '''Stretching arms and razor-sharp claws make this monster a formidable opponent.''',
    '''A sorcerer that can paralyze an enemy with a single curse.''',
    '''A lady monster dwelling in a flower, she sprinkles the air with poisonous pollen.''',
    '''A crystal monster that unleashes a brilliant light to blind enemies.''',
    '''This warrior's fatal dance is performed with a lethal sickle.''',
    '''This creature may look slim and weak, but it's protected by a mystical force.''',
    '''A creature that defeats its enemies using sleight-of-hand.''',
    ...
    '''This weird monster has a portal in its belly that brings reinforcements from the farthest reaches of the netherworld.''',
    '''This two-headed creature spits laser blasts at its enemies.''',
    '''@5"Petit Angel"@7 + @5"Mystical Sheep #2"@7''',
    '''A sorcerer who utters spells that can render monsters unconscious.''',
    ...
    '''An ammonite warrior that has protected the seas throughout history.''',
    '''A little fairy that fires beams of happiness from the heart-shaped jewel on its forehead.''',
    ...
    '''This ugly monster emits a highly poisonous gas.''',
    '''With whip-like arms, this creature can attack enemies from a distance.''',
    '''A monster that shocks its enemies with its massive beak and ear-piercing wails.''',
    ...
    '''@5"Skull Servant"@7 + @5"Dissolverock"@7''',
    '''A spirit of the forest powered by the surrounding trees and wildlife.''',
    '''@5"Summoned Skull"@7 + @5"Red-Eyes B. Dragon"@7''',
    ...
    '''This monster only appears when a midnight tribute is made.''',
    '''FLIP: Select 1 Trap Card on the field and destroy it. If the selected card is Set, pick up and see the card. If it is a Trap Card, it is destroyed. If it is a Spell Card, return it to its original position.''',
    '''Whoever resists the curse of this blade will gain untold power.''',
    '''Swift and deadly, this monsters grabs victims with its claws and attacks with a poison stinger.''',
    '''A rabid starfish that spits a lethal acid that can melt almost anything.''',
    '''A living corpse of wood re-animated by the powers of darkness.''',
    '''This creature grants power instead of shortening life.''',
    '''@5"Fusionist"@7 + @5"Enchanting Mermaid"@7''',
    '''A creature with a wicked smile and a lethal sickle.''',
    '''A living weapon that spits projectiles.''',
    ...
    '''This dangerous creature brandishes a soul-sucking sword.''',
    ...
    '''None can survive the cold touch of this sub-zero warrior.''',
    ...
    '''An imperfect monster with a belly vortex that sucks in opponents of any size.''',
    ...
    '''You can substitute this card for any 1 Fusion-Material Monster. When you do this, the other Fusion-Material Monster(s) must be the correct one(s).''',
    '''Armed with an array of spell wands, this creature is capable of multiple attacks.''',
    '''A lovely creature guarded by the moon, her lunar curtain can block just about any attack.''',
    ...
    '''@5"Tyhone"@7 + @5"Wings of Wicked Flame"@7''',
    '''This ancient arbor uses its extensive knowledge to avoid the damage of enemy attacks.''',
    ...
    '''The gorgon egg's massive eyes are said to reflect the fate of its enemies.''',
    ...
    '''This machine generates illusions that leave an enemy wide open to attacks.''',
    '''Master of Yin and Yang, this wizard handles a delicate balance of spells and counterspells.''',
    '''A snake with a single eye that can chill the enemy, freezing them on the spot.''',
    ...
    '''@5"Armaill"@7 + @5"One-Eyed Shield Dragon"@7''',
    '''A monster created from a major accident in an underground lab.''',
    ...
    '''An Insect-Type monster equipped with this card increases its ATK by 700 points.''',
    ...
    '''You can only activate this card when there are 1 or more @5"Harpie Lady"@7 on the field. Special Summon 1 @5"Harpie Lady"@7 or @5"Harpie Lady Sisters"@7 from your hand or your Deck.''',
    ...
    '''Flip face-up all face-down monsters on your opponent's side of the field. The effect of the monsters will activate at this time.''',
    '''A treasure box containing a monster that attacks any unwary bandit.''',
    '''A lady warrior armed with sword and shield, she floats like a butterfly and stings like a bee.''',
    ...
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"War-Lion Ritual"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''A pair of friendly skeletons, lean and fat, that travel with extreme difficulty.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Zera Ritual"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''A very rare penguin that takes to the air with ears shaped like wings.''',
    '''A Millennium item, it's rumored to block any strong attack.''',
    '''A Millennium item, it's rumored to block any strong attack.''',
    '''This flying monster is known for delivering happiness to all.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Black Luster Ritual"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Beastly Mirror Ritual"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''These walls form a labyrinth no exit for enemies.''',
    '''When you declare an attack with this card, toss a coin and call it. If you call it right, attack normally. If you call it wrong, decrease your Life Points by half before attacking.''',
    '''Increase the ATK of this monster by 100 points for each monster in your Graveyard.''',
    '''You cannot Normal Summon this monster. This card can only be Special Summoned by offering @5"Labyrinth Wall"@7 equipped with @5"Magical Labyrinth"@7 as a Tribute. No other Tribute Monsters are necessary.''',
    '''@5"Giga-Tech Wolf"@7 + @5"Cannon Soldier"@7''',
    ...
    '''You can only activate this card's effect during your opponent's damage calculation. Make the ATK of a monster attacking this card 0 during damage calculation. This effect can only be used once as long as this card remains face-up on the field.''',
    '''You can only activate this card's effect during your opponent's damage calculation. Make the ATK of a monster attacking this card 0 during damage calculation. This effect can only be used once as long as this card remains face-up on the field.''',
    '''This card can only be Special Summoned by offering @5"Sanga of the Thunder"@7, @5"Kazejin"@7 and @5"Suijin"@7 on your side of the field as a Tribute.''',
    ...
    '''A genie of the lamp that's at the beck and call of its master.''',
    '''@5"Blue-Eyes White Dragon"@7 + @5"Blue-Eyes White Dragon"@7 + @5"Blue-Eyes White Dragon"@7''',
    '''@5"Blue-Eyes White Dragon"@7 + @5"Blue-Eyes White Dragon"@7 + @5"Blue-Eyes White Dragon"@7''',
    ...
    '''@5"Crass Clown"@7 + @5"Dream Clown"@7''',
    '''Increases the ATK and DEF of this card by 300 points for each face-up @5"Harpie Lady"@7 on the field.''',
    '''A horrible torture machine with a large pendulum blade.''',
    '''A horrible torture machine with a large pendulum blade.''',
    '''@5"Guardian of the Labyrinth"@7 + @5"Protector of the Throne"@7''',
    ...
    '''This monster can only be Special Summoned from your Deck to your side of the field by offering @5"Zoa"@7 equipped with @5"Metalmorph"@7 as a Tribute.''',
    '''Frightening in appearance, this creature uses its large eyes and ears to keep track of any movement.''',
    '''At the cost of 1000 Life Points, you can return @5"Polymerization"@7 from the Graveyard to your hand.''',
    ...
    '''@5"Steel Ogre Grotto #1"@7 + @5"Lesser Dragon"@7''',
    ...
    '''This monster has several components that can be launched for formation attacks.''',
    '''An iron giant that appears from a dimensional rift.''',
    ...
    '''Discard this card from your hand to the Graveyard to add up to 2 @5"Thunder Dragon"@7 cards from your Deck to your hand. Then shuffle your Deck. You can only use this effect during your Main Phase.''',
    '''@5"Winged Dragon, Guardian of the Fortress #1"@7 + @5"Fairy Dragon"@7''',
    ...
    '''This monster hypnotizes an opponent with the ball on its tail and drags them to a watery doom.''',
    ...
    '''A monster crab with huge claws for clipping enemies to little pieces.''',
    '''A lethal crawfish with extremely dangerous claws.''',
    '''For nearly a millennium, this golem has served as guardian of an ancient treasure trove.''',
    '''A golem with a massive right hand for crushing its victims.''',
    '''Shouldering a pair of machine guns, this monster is unstoppable.''',
    '''A rock warrior that wields a heavy blade carved from stone.''',
    '''With a head that erupts when angered, this monster launches a dangerous shower of boulders.''',
    '''@5"Ocubeam"@7 + @5"Mega Thunderball"@7''',
    '''This creature attacks with electromagnetic waves.''',
    '''With both arms forming an electric whip, this monster paralyzes its enemies with electric shocks.''',
    '''FLIP: Increase 3000 Life Points. When this card is sent from the field to the Graveyard, you lose 5000 Life Points.''',
    ...
    '''@5"Lord of the Lamp"@7 + @5"Invader from Another Dimension"@7''',
    '''@5"Rhaimundos of the Red Sword"@7 + @5"Fireyarou"@7''',
    '''A merciless monster that tears opponents to shreds with razor-like claws.''',
    '''During your Standby Phase, if a @5"Sinister Serpent"@7 exists in your Graveyard, you can return the @5"Sinister Serpent"@7 to your hand.''',
    '''A crab that binds its enemies with a sticky web and attacks them with its sharp claws.''',
    ...
    '''This monster rolls a massive hunk of manure to crush its opponent.''',
    '''A book-like wizard with a wealth of spell written inside.''',
    '''@5"Silver Fang"@7 + @5"Darkworld Thorns"@7''',
    '''This monster may attack your opponent's Life Points directly.''',
    '''This wicked flower attacks enemies with pollen projectiles.''',
    '''As long as this card remains face-up on the field, increase the ATK of all LIGHT monsters by 500 points and decrease the ATK of all DARK monsters by 400 points.''',
    '''Increase the ATK of this card by 500 points for each Equip Spell Card equipped to this card.''',
    '''@5"Witch of the Black Forest"@7 + @5"Lady of Faith"@7''',
    '''A rabid rabbit that tears its way through opposition with its sharp claws.''',
    ...
    '''This crystalline monster filters light to create a lethal laser.''',
    '''A flying fish that attacks with its pointed head.''',
    '''@5"Two-Headed King Rex"@7 + @5"Crawling Dragon #2"@7''',
    '''A flower whose laugh can confuse the minds of enemies.''',
    ...
    '''As long as this card remains face-up on the field, increase the ATK and DEF of this card by 300 points for every card in the controller's hand.''',
    '''A stone turtle that is nearly indestructible.''',
    ...
    '''@5"Takuhee"@7 + @5"Temple of Skulls"@7''',
    '''Few have set eyes on this dive-bombing bird and lived to tell the tale.''',
    '''When this card inflicts Battle Damage to your opponent's Life Points, your opponent draws 2 cards from his/her Deck.''',
    ...
    '''The cane of this monster is the source of many powerful spells.''',
    '''@5"Giant Soldier of Stone"@7 + @5"Ancient Elf"@7''',
    ...
    '''@5"The Snake Hair"@7 + @5"Blackland Fire Dragon"@7''',
    '''A fish with arms, legs, and some very sharp teeth.''',
    ...
    '''With a large mouth and massive teeth, this is one dangerous and strange sea snake.''',
    ...
    '''A monster that wanders the edges of the netherworld.''',
    '''A steel idol worshipped in the Land of Machines.''',
    '''A strange warrior from another dimension.''',
    '''An extraterrestrial monster that came from a distant galaxy.''',
    '''A minor dragon incapable of breathing fire.''',
    '''FLIP: Discard 5 cards from the top of your opponent's Deck to his/her Graveyard.''',
    '''A harmless monster found in just about any attic.''',
    '''@5"The Snake Hair"@7 + @5"Dragon Zombie"@7''',
    '''@5"Sea Kamen"@7 + @5"Gruesome Goo"@7 + @5"Amazon of the Seas"@7''',
    ...
    '''Man-like dinosaur with a high I.Q. that is lacking in strength.''',
    ...
    '''A tyrannosaurus offspring with a vicious disposition.''',
    ...
    '''An extraordinary blue scorpion found in the tundra, not in the desert.''',
    '''A rarely seen flower that blossoms quietly on the edge of darkness.''',
    '''This bird is known far and wide as a harbinger of doom.''',
    '''The mystic links of this chain can rob enemies of their power.''',
    ...
    '''A further step in the evolutionary chain, it is much more powerful than Larvas.''',
    '''A living vase that bites enemies and blinds them with a blast of pollen from its flower.''',
    '''This monster reaches out with a long blue tendril and grabs anything that wanders nearby.''',
    '''This monster wraps itself around an opponent and pecks away with its huge beak.''',
    ...
    '''@5"Feral Imp"@7 + @5"Snakeyashi"@7''',
    '''This monster can draw its enemies into mirror world that renders them helpless.''',
    '''A monster with a very big appetite that has never been satisfied.''',
    ...
    '''This monster can call up sudden torrents of battering rain.''',
    '''The power of this monster lies in its ability to suppress the good and bring out the bad in any monster.''',
    ...
    '''An ill-mannered field mouse that will sink its fangs into anything.''',
    '''A liquid life form that thrives on water.''',
    '''An amphibious creature with two whip-like tails.''',
    '''This beast has a mouth that will swallow anything.''',
    ...
    '''@5"Thunder Dragon"@7 + @5"Thunder Dragon"@7''',
    '''A bluish starfish with a solid hide capable of fending off attacks.''',
    '''@5"Water Magician"@7 + @5"Behegon"@7''',
    '''@5"Sonic Maid"@7 + @5"Beautiful Headhuntress"@7''',
    '''This monster is formed by several serpents that break off to individually attack nearby enemies.''',
    '''This monster melts its way underground to attack enemies from below.''',
    '''A very agile half-fish warrior known for its relentless attacks.''',
    '''This fairy protects a fountain from any who seek to muddy its waters.''',
    '''A mermaid who serves as herald of the Sea King and guards the sanctuary.''',
    ...
    '''A lizard warrior protected by a hide of very tough emerald scales.''',
    '''With hair shaped like a crown and a body encased in bluish white flames, this bird is a formidable sight.''',
    '''@5"Ground Attacker Bugroth"@7 + @5"Guardian of the Sea"@7''',
    ...
    '''A mechanized soldier created to protect royalty.''',
    '''A slime boss that is definitely tougher than it looks.''',
    '''Attacks from the skies with a whip-like tail.''',
    '''You can shift an opponent's monster in Attack Position to Defense Position. In addition, you can increase the ATK of 1 of your own monsters by 500 points.''',
    '''You can shift an opponent's monster in Attack Position to Defense Position. In addition, you can increase the ATK of 1 of your own monsters by 500 points.''',
    '''Equip @5"Labyrinth Wall"@7 with this card. If you offer @5"Labyrinth Wall"@7 equipped with this card as a Tribute, you can Special Summon @5"Wall Shadow"@7 from your Deck.''',
    ...
    '''After activation, this card is used to equip a face-up monster. The monster equipped with this card increases its ATK and DEF by 300 points. When attacking with a monster equipped with this card, you can further increase its ATK by an amount equal to half the ATK of your target.''',
    '''Offer 1 DARK monster with an ATK of 1000 or less on your side of the field as a Tribute. You and your opponent check all monsters on your opponent's side of the field, your opponent's hand, and all cards during your opponent's next 3 turns he/she draws and destroy all monsters with an ATK of 1500 or higher.''',
    '''Offer 1 DARK monster with an ATK of 1000 or less on your side of the field as a Tribute. You and your opponent check all monsters on your opponent's side of the field, your opponent's hand, and all cards during your opponent's next 3 turns he/she draws and destroy all monsters with an ATK of 1500 or higher.''',
    ...
    '''This card is used to Ritual Summon @5"Black Luster Soldier"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Zera The Mant"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''Destroys all of your opponent's Magic and Trap Cards on the field.''',
    '''Destroys all of your opponent's Magic and Trap Cards on the field.''',
    '''This card is used to Ritual Summon @5"Super War-Lion"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Fiend's Mirror"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Performance of Sword"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Hungry Burger"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Skull Guardian"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    ...
    '''You can only activate this card when your opponent declares an attack. Destroy 1 monster with the highest ATK among your opponent's Attack Position monsters.''',
    '''As long as this card remains face-up on the field, the effect of increasing your opponent's Life Points is changed to inflict the same amount of points in damage to your opponent's Life Points.''',
    '''All increases and decreases to ATK and DEF are reversed for the turn in which this card is activated.''',
    '''This card is used to Ritual Summon @5"Crab Turtle"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Chakra"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Javelin Beetle"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Garma Sword"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Dokurorider"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Fortress Whale"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Commencement Dance"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Hamburger Recipe"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''An unstoppable savage that carries a Millennium Item.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Novox's Prayer"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    ...
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Resurrection of Chakra"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Turtle Oath"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''A dragon warrior of the moon armed with a crescent sword.''',
    '''This dragon appeared from the heavens and crashed to earth.''',
    '''@5"Red-Eyes B. Dragon"@7 + @5"Meteor Dragon"@7''',
    '''A heavenly stallion soaring through the skies on crimson wings.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Garma Sword Oath"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Javelin Beetle Pact"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Fortress Whale's Oath"@7. You must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Revival of Dokurorider"@7. You must also offer monsters whose total Level Stars equal 6 or more as a Tribute from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Magician of Black Chaos"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Dark Magic Ritual"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    ...
    '''@5"Relinquished"@7 + @5"Thousand-Eyes Idol"@7 As long as this card remains face-up on the field, other monsters cannot change their Battle Positions or attack. Select 1 monster on your opponent's side of the field and equip it to this card (this effect can only be used once per turn and you can only equip 1 monster at a time to this card). The ATK and DEF of this card become the same amounts as the monster equipped to this card. If this card is destroyed as a result of battle, the equipped monster is destroyed instead.''',
    ...
    '''A dragon created from a massibe diamond that sparkles with blinding light.''',
    ...
    '''This card can only be Special Summoned from the Deck to the field by offering @5"Red-Eyes B. Dragon"@7 equipped with @5"Metalmorph"@7 as a Tribute. Your Deck is then shuffled.''',
    '''This card can only be Special Summoned from the Deck to the field by offering @5"Red-Eyes B. Dragon"@7 equipped with @5"Metalmorph"@7 as a Tribute. Your Deck is then shuffled.''',
    ...
    '''When this card is Summoned successfully, place 1 Spell Counter on it (maximum of 1). Remove the Magic Counter to destroy one face-up Trap Card in the Field.''',
    '''This card cannot attack unless you offer 1 of your monsters on the field as a Tribute.''',
    '''This card cannot attack unless you offer 1 of your monsters on the field as a Tribute.''',
    ...
    '''Any Battle Damage your opponent takes when they attack this monster is doubled.''',
    '''When this card is summoned (excluding Special Summon), you can add 1 @5"Gazelle the King of Mythical Beasts"@7 from your Deck to your hand.''',
    '''@5"Gazelle the King of Mythical Beasts"@7 + @5"Berfomet"@7 When this card is destroyed, you can Special Summon either @5"Gazelle the King of Mythical Beasts"@7 or @5"Berfomet"@7 from your Graveyard, and place it on the field face-up in either Attack or Defense position.''',
    '''Once per turn, during your Main Phase 1, by paying 800 Life Points, this card can attack your opponent's Life Points directly this turn.''',
    ...
    '''When this card is Normal Summoned, Flip Summoned, or Special Summoned successfully, select and activate 1 of the following effects: @4 @7Select 1 Equip Card equipped to 1 monster on the field and destroy it. @4 @7Select 1 Equip Card equipped to 1 monster on the field and equip it to this card.''',
    ...
    '''Negate the activation of a Spell Card that designates this 1 face-down monster. At that time, flip this card into face-up Defense Position. If this card is attacked, change the Battle Position of this card to Attack Position at the end of the Damage Step.''',
    '''Increase the ATK of this monster by 300 points for each @5"Dark Magician"@7 or @5"Magician of Black Chaos"@7 in either player's Graveyard.''',
    '''Increase the ATK of this monster by 300 points for each @5"Dark Magician"@7 or @5"Magician of Black Chaos"@7 in either player's Graveyard.''',
    '''Increase the ATK of this monster by 300 points for each @5"Dark Magician"@7 or @5"Magician of Black Chaos"@7 in either player's Graveyard.''',
    '''This lizard man can swing a sword at velocities that exceed the speed of sound.''',
    '''You cannot declare an attack without Tributing 1 monster on your side of the field. Increase the ATK of this card by 200 points for each face-up Insect-Type monster on the field. Special Summon 1 @5"Insect Monster Token"@7 (Insect-Type/EARTH/1 Star/ATK 100/DEF 100) in Attack Position on your side of the field during the End Phase of each turn that this card destroys your opponent's monster.''',
    ...
    '''When this card inflicts Battle Damage to your opponent's Life Points, you can select 1 @5"Parasite Paracide"@7 card from your Deck, shuffle the Deck, and place @5"Parasite Paracide"@7 on top of the Deck.''',
    '''As long as @5"Umi"@7 is face-up on the field, this card is unaffected by any Spell Cards.''',
    '''This card cannot be destroyed in battles with monsters that are Level 7 or below. This card receives an additional 1000 ATK each time you reach an End Phase. After each attack, this card's ATK returns to 0.''',
    '''@5"Zombyra the Dark"@7 + @5"Maryokutai"@7 When this card is Special Summoned, destroy all monsters on your side of the field except this card. As long as this card remains face-up on the field, neither player can Normal Summon, Flip Summon or Special Summon any monster.''',
    '''Even when the odds are against this brave fairy, this monster will engage in battle and never run away.''',
    ...
    '''A winged dragon brought back to life by means of modern technology.''',
    '''Alpha, Beta, and Gamma meld as one to form a powerful monster.''',
    ...
    '''When this card is Summoned (including Special Summon) it adopts the original ATK and DEF of 1 opponent's monster.''',
    '''Pay 1000 Life Points to activate this card.''',
    '''Pay 1000 Life Points to activate this card.''',
    '''Until the end of the End Phase, all effects of monsters on the field in Defense Position are negated.''',
    '''This card is used to Ritual Summon @5"Relinquished"@7. You must also Tribute monsters whose total Level Stars equal 1 or more from the field or your hand.''',
    ...
    '''Offer 1 face-up @5"Kuriboh"@7 as a Tribute. Place a @5"Kuriboh Token"@7 (Fiend-Type/DARK/1 Star/ATK 300/DEF 200) in Defense Position on each open Monster Card Zone. These tokens cannot be used as Tribute Monsters.''',
    ...
    '''You can only activate this card when @5"Lord of D."@7 is face-up on the field. Special Summon up to 2 Dragon-Type monsters from your hand to your side of the field.''',
    '''Switch the original ATK and DEF of all face-up monsters on the field until the end of the End Phase. Any additions and subtractions to ATK and /or DEF due to card effects are applied to the new ATK and DEF. Monsters summoned after this card's activation are excluded.''',
    ...
    '''When this card is played your opponent cannot change the position of monsters during his/her next turn.''',
    ...
    '''When this card is activated, you cannot summon any monster in the same turn (including Flip Summon and Special Summon). Place 4 @5"Sheep Tokens"@7 (Beast-Type/EARTH/1 Star/ATK 0/DEF 0) in Defense Position on your side of the field. The tokens cannot be used as a Tribute for a Tribute Summon.''',
    '''You can only equip this card to @5"Jinzo"@7. As long as this card is equipped, the effects of Trap Cards controlled by the equipped monster's controller are not negated by the effect of the equipped monster. When this card is removed from the field, the equipped monster is destroyed. This card's activation and effect cannot be negated by any other card.''',
    ...
    '''When this card is activated, you cannot summon any monster in the same turn (including Flip Summon and Special Summon). You can Special Summon 1 @5"Dark Magician"@7 from your Deck at the cost of half your Life Points.''',
    '''Your opponent cannot declare an attack with any Insect-Type monsters on his/her side of the field.''',
    '''You can activate this card when your opponent announces an attack. Select 1 of your opponent's face-up Monster Cards on the field and designate it as the target of the attack.''',
    ...
    '''Select 2 Monster Cards from your opponent's Graveyard. These Monster Cards are removed from play for the remainder of the Duel.''',
    ...
    '''Pay 1000 of your Life Points. Negate the activation of a Trap Card and destroy it.''',
    ...
    '''Add 1 @5"Polymerization"@7 card from your Deck to your hand. Then shuffle your Deck.''',
    '''A Monster Card equipped with this card increases its ATK and DEF by 500 points. When this card is sent to the Graveyard, place it on top of your Deck.''',
    ...
    '''Each time 1 monster on your side of the field inflicts Battle Damage to your opponent's Life Points, your opponent discards 1 card randomly from his hand.''',
    ...
    '''This card can only be equipped to monster on your side of the field. Decrease the ATK and DEF of a monster equipped with this card by 500 points. In addition, all the monsters on your opponent's side of the field can only attack the monster equipped with this card.''',
    '''Tribute 1 monster on your side of the field. Your opponent must Tribute 1 monster on his/her side of the field.''',
    '''A monster equipped with this card increases its ATK by 700 points. Its ATK is then decreased by 200 points at each of its Standby Phases.''',
    ...
    '''Switch the opponent's Spell Card effect that specifically designates 1 monster as a target to another correct target.''',
    ...
    '''When this card is sent to the Graveyard as a result of battle, inflict 500 points of damage to your opponent's Life Points. You can also Special Summon up to 2 @5"Giant Germ"@7 cards from your Deck to your side of the field in face-up Attack Position. Then shuffle your Deck.''',
    '''When this card is sent to the Graveyard as a result of battle, increase your Life Points by 1000 points. You can also Special Summon up to 2 @5"Nimble Momonga"@7 cards from your Deck to your side of the field in face-down Defence Position. Then shuffle your Deck.''',
    ...
    '''You can only activate this card when you take damage to your Life Points. Increase your Life Points by 1000 points. Also, increase your Life Points by 500 points for each @5"Numinous Healer"@7 card in your Graveyard.''',
    '''You can activate this card when your opponent draws a card outside of his/her Draw Phase. Draw 2 cards from your Deck.''',
    ...
    '''You can only activate this card when you take damage to your Life Points. Inflict 700 points of damage to your opponent's Life Points. Also, inflict 300 points of damage to your opponent's Life Points for each @5"Attack and Receive"@7 card in your Graveyard.''',
    ...
    '''FLIP: You can Special Summon 1 @5"Bubonic Vermin"@7 from your Deck in face-down Defense Position. Then shuffle your Deck.''',
    ...
    '''This card can only be Special Summoned by offering @5"Alpha The Magnet Warrior"@7, @5"Beta The Magnet Warrior"@7, and @5"Gamma The Magnet Warrior"@7 from your hand or the field as a Tribute. If @5"Alpha The Magnet Warrior"@7, @5"Beta The Magnet Warrior"@7, and @5"Gamma The Magnet Warrior"@7 exist in the Graveyard, you can offer this card as a Tribute to Special Summon these 3 cards to the field.''',
    '''@5"Baby Dragon"@7 + @5"Alligator's Sword"@7 You can Inflict Direct Damage to your opponent's Life Points with this card if the only Attributes of Monster Cards on your opponent's side of the field are EARTH, WATER, or FIRE.''',
    '''The axe in the hand of this evil animal has tasted the blood of many monsters.''',
    '''The axe in the hand of this evil animal has tasted the blood of many monsters.''',
    ...
    '''As long as this card remains face-up on the field, destroy all monsters with an ATK equal to 1400 or less that are Normal Summoned or Special Summoned (excluding Flip Summon).''',
    ...
    '''When this card is sent to the Graveyard as a result of battle, you can add 1 @5"Harpie Lady"@7 from your Deck to your hand. Then shuffle your Deck.''',
    ...
    '''When this card attacks with an ATK higher than the DEF of a Defense Position monster, inflict the difference as Battle Damage to your opponent's Life Points. When this card inflicts Battle Damage to your opponent's Life Points, draw 1 card from your Deck.''',
    '''As long as this card remains in face-up Defence Position on the field, increase the ATK and DEF of all Plant-Type monsters on your side of the field by 500 points.''',
    ...
    '''As long as this card remains face-up on the field, the field is treated as @5"Umi"@7 (however there is no increasing or decreasing of ATK/DEF due to @5"Umi"@7's effect). If there is an active Field Spell Card on the field, this effect is not applied.''',
    ...
    '''This card's effect can be activated only during the Damage Step of either player's turn that this card battles. Pay 2000 Life Points to increase the ATK of this monster by 3000 points only during the Damage Step.''',
    '''Send 1 Equip Card equipped to this card to the Graveyard. Inflict 500 points of damage for each Equip Card to your opponent's Life Points.''',
    ...
    '''This monster may attack your opponent's Life Points directly.''',
    '''FLIP: Each player selects a card from the other's hand and discards it. Any monster destroying this card during battle loses 500 points from its ATK and DEF.''',
    ...
    '''@5"Worm Drake"@7+@5"Humanoid Slime"@7''',
    ...
    '''The effect of this card can only be applied during the Battle Phase of your own turn. Any damage this monster takes is reduced to 0. Any monster attacked by this card has its ATK decreased by 500 points until the end of that turn.''',
    '''As long as @5"Umi"@7 is face-up on the field, this card is unaffected by any Spell Cards. Monsters on your opponent's side of the field cannot select this card as an attack target.''',
    ...
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"Curse of the Masked Beast"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    ...
    '''This card is used to Ritual Summon @5"The Masked Beast"@7. You must also offer monsters whose total Level Stars equal 8 or more as a Tribute from the field or your hand.''',
    ...
    '''Neither player can offer any monster as a Tribute under any conditions.''',
    ...
    '''This card can only be activated when @5"Umi"@7 is active on the field. As long as @5"Umi"@7 remains face-up on the field, any damage from attacking monsters to your Life Points becomes 0. When @5"Umi"@7 is removed from the field, this card is also destroyed.''',
    ...
    '''Tribute 1 Insect-Type Monster on your side of the field. Special Summon 2 @5"Army Ant Tokens"@7 (Insect-Type/EARTH/Level 4/ATK 500/DEF 1200) on your side of the field. The tokens cannot be used as a Tribute for a Tribute Summon.''',
    '''Return 1 Fusion Monster on the field to the Fusion Deck. In addition, if all the Fusion Material Monsters for the returned Fusion Monster Card are in your Graveyard, you can Special Summon them all to the field in face-up Attack or Defense Position.''',
    '''During each of your Standby Phases, Special Summon 1 @5"Slime Token"@7 (Aqua-Type/WATER/LEVEL 1/ATK 500/DEF 500) in Attack Position to your side of the field. As long as this card remains face-up on the field, you cannot Normal Summon, Flip Summon or Special Summon any other monster (except Slime Tokens).''',
    ...
    '''When a monster on your opponent's side of the field attacks a monster on your side of the field and there is a face-up @5"Revival Jam"@7 on your side of the field, you can switch the attack target to the @5"Revival Jam"@7.''',
    ...
    '''You can Special Summon to your side of the field a monster destroyed and sent to the Graveyard as a result of battle by this card at the end of the Battlle Phase.''',
    ...
    '''The ultimate wizard in terms of attack and defense.''',
    '''You can only activate this card when you have a face-up @5"Dark Magician"@7 on your side of the field. Destroy 1 monster on your opponent's side of the field.''',
    ...
    '''Offer 2 monsters on your side of the field as a Tribute to inflict 1200 points of damage to your opponent's Life Points.''',
    ...
    '''Offer this face-up card as a Tribute to return to your hand 1 of your monsters destroyed as a result of battle during this turn.''',
    '''@5"The Forgiving Maiden"@7 + @5"Marie the Fallen One"@7''',
    ...
    '''Only @5"Dark Magician"@7 or @5"Dark Magician Girl"@7 may equip this. The Monster that equips this will gain 700 ATK. When this card is sent to the Graveyard, you recover 1000 Life Points.''',
    '''At the end of each of your opponent's turns, place 1 @5"Spirit Message"@7 card from your hand or your Deck face-up to the field. If it is from your Deck, then shuffle your Deck. When @5"Spirit Message"@7 cards @5"I"@7, @5"N"@7, @5"A"@7, and @5"L"@7 are all on your side of the field in their proper order, you are declared the winner. If any of the cards are removed from the field while constructing the message, they are all sent to your Graveyard immediately.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card can only be Special Summoned from your hand or your Deck by offering 1 @5"Dark Magician"@7 on your side of the field as a Trbute when you succeed in the effect of @5"Time Wizard"@7. At that time, select 1 Spell Card from your Deck, add it to your hand, and then shuffle your Deck.''',
    '''The controller of this card can activate Traps on the turn they are set. Additionally, by sending this card and @5"Mystical Beast Serket"@7 to the Graveyard when they are on your Field, you may select one Monster Card from your Hand, Deck, or Fusion Deck and Special Summon it.''',
    ...
    '''This card can only be activated during a Main Phase. After activating, it becomes a Monster Card (Reptile-Type/EARTH/4 Star/ATK 1600/DEF 1800), and Special Summons in the Monster Card zone (Also treated as a Trap Card).''',
    '''Select one Monster from your Deck and send it to the Graveyard. Afterward, shuffle your Deck.''',
    '''Select either @5"Summoned Skull"@7 or any Thunder-Type monster. All opponent's monsters with DEF lower than the ATK of the selected card are destroyed. You must skip your Battle Phase during the turn this card is activated.''',
    '''When this monster is attacked in face-down Defense Position, you can designate 1 opponent's monster as the attack's target instead. When this card is on the field, you can Special Summon @5"La Jinn the Mystical Genie of the Lamp"@7 from your hand.''',
    '''This card's name is treated as @5"Harpie Lady"@7.''',
    '''This card is destroyed unless you have @5"Cathedral of Nobles"@7 on your Field. Each time this card destroys a monster in battle, that monster is removed from play, and this card receives a 500 point ATK bonus.''',
    ...
    '''Discard 1 card from your hand to the Graveyard randomly to destroy all Special Summoned monsters on the field. In addition, as long as this card remains face-up on the field, no monsters can be Special Summoned.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card can only be Special Summoned by removing 2 LIGHT monsters in your Graveyard from play. As long as this card remains face-up on the field, decrease the ATK of all monsters on your opponent's side of the field by 300 points during his/her Battle Phase.''',
    ...
    '''This card cannot be Normal Summoned or Set. This monster can only be Special Summoned by removing 1 EARTH monster in your Graveyard from play. Increase the ATK of this monster by 300 points during your opponent's Battle Phase.''',
    '''This monster can only be Special Summoned by removing 1 WIND monster in your Graveyard from play. As long as this monster remains face-up on the field, you may change the battle position of 1 of your opponent's face-up Monster Cards at each End Phase of your opponent's turn.''',
    '''You can treat the Normal Summon of this card as a Special Summon. If you select Special Summon, your opponent can Special Summon 1 monster from his/her Graveyard.''',
    ...
    '''Remove from play any number of monsters in your Graveyard to destroy 1 face-up monster on the field whose Level Stars are equal to the number of the cards you removed from play.''',
    ...
    '''Select 1 monster face-up on the field. Increase the selected monster's ATK by 100 points for each monster in your Graveyard during the turn this card is activated. The number of monster is applied when this card is activated.''',
    ...
    '''During your Standby Phase, roll 1 six-sided die once. Destroy any monsters whose Level Stars are equal to the number rolled. (If the number is @5"6"@7, destroy all face-up Level 6 or higher monsters on the field.)''',
    '''Negate the effects of all Equip Cards.''',
    '''This card can only be equipped to @5"Gradius"@7. Increase the ATK of @5"Gradius"@7 by 300 points. When @5"Gradius"@7 attacks with an ATK that is higher than the DEF of a Defense Position monster, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''This card can only be placed on the field by the effect of @5"Destiny Board"@7.''',
    '''This card can only be placed on the field by the effect of @5"Destiny Board"@7.''',
    '''This card can only be placed on the field by the effect of @5"Destiny Board"@7.''',
    '''This card can only be placed on the field by the effect of @5"Destiny Board"@7.''',
    ...
    '''As long as this card remains face-up on the field, a Fusion Monster can be Special Summoned without using @5"Polymerization"@7 Spell Card. The Fusion-Material monsters used in the Fusion Summon are not sent to the Graveyard, but are removed from play.''',
    '''A monster equipped with this card cannot attack. Destroy the equipped monster at the end of the 2nd turn of the controller of the equipped monster. At that time, this card is returned to the owner's hand.''',
    '''If 5 or more of your monsters have been removed from play, return 3 of them to the Graveyard.''',
    '''All monsters on the field cannot attack during the same turn that they are Normal Summoned, Flip Summoned or Special Summoned.''',
    '''The opponent takes all Battle Damage to this card's controller that he/she would take from a battle involving this card.''',
    '''During the turn this card is sent to the Graveyard, the owner of this card can activate Trap Card(s) from his/her hand.''',
    '''You can only activate this card when your opponent declares an attack and if there is a monster(s) on your side of the field that includes @5"Amazoness"@7 in its card name, or is named @5"Amazon Archer"@7. All monsters on your opponent's side of the field are changed to face-up Attack Position (Flip Effects are not activated), and as long as they remain face-up on the field, their ATK(s) are decreased by 500 points. Your opponent must attack with all of his/her monsters.''',
    ...
    '''Destroys all face-up Spell Cards controlled by your opponent on the Field. For each Spell Card destroyed, your opponent receives 500 damage.''',
    ...
    '''@5"Possessed Dark Soul"@7 + @5"Frontier Wiseman"@7 A Fusion Summon of this monster can only be conducted with the above Fusion Material Monsters. When a Normal Spell Card is activated, negate the effect by paying 1000 Life Points. The effect of an Effect Monster that this monster destroys as a result of battle is negated.''',
    '''As long as this monster remains face-up on the field, monsters destroyed by this monster as a result of battle are removed from play instead of being sent to the Graveyard.''',
    ...
    '''You can only activate this card during the Damage Step of the Battle Phase that a Fiend-Type monster on your side of the field attacks or is attacked. Pay Life Points (in multiples of 100 points) to decrease 1 of your opponent's monster's ATK and DEF by the same amount of points until the End Phase of that turn.''',
    ...
    '''Destroy 1 face-up card on the field that has the effect that negates Trap Cards' effects.''',
    '''Negate the effect of any Spell Card that targets this card and destroy it. As long as this card remains face-up on the field, you can add 1 Level 4 or lower Warrior-Type monster from your Deck to your hand per turn instead of drawing 1 card from your Deck during your Draw Phase. Then shuffle your Deck.''',
    ...
    '''While this monster is face-up on the field, your opponent cannot select another Warrior-Type monster on your side of the field as an attack target. When this monster is Normal Summoned successfully, you can Special Summon 1 Level 4 or lower monster from your hand.''',
    '''@5"Warrior Dai Grepher"@7 + @5"Spirit Ryu"@7 A Fusion Summon of this monster can only be conducted with the above Fusion Material Monsters. As long as this card remains face-up on the field, negate the effect of a Normal Trap Card by paying 1000 Life Points. Negate the effects of a Spell Card that targets this card and destroy it.''',
    '''The warrior who can manipulate dragons. Nobody knows his mysterious past.''',
    '''As long as this card remains face-up on your side of the field, negate the effects of Spell Cards that target face-up Warrior-Type monsters on your side of the field and destroy the Spell Card.''',
    ...
    '''Increase the ATK of all Warrior-Type monsters on your side of the field by 200 points for each face-up Warrior-Type and Spellcaster-Type monster on your side of the field.''',
    ...
    '''Select 1 Warrior-Type monster in your Graveyard and add it to your hand.''',
    ...
    '''If this card attacks with an ATK that is higher than the DEF of a Defense Position monster, inflict the difference as Battle Damage to your opponent's Life Points. If this card attacks, it is changed to Defense Position at the end of the Damage Step.''',
    ...
    '''@5"Cave Dragon"@7 + @5"Lesser Fiend"@7 A Fusion Summon of this monster can only be conducted with the above Fusion Material Monsters. As long as this card remains face-up on the field, negate the effects of Flip Effect Monsters. Negate the effects of a Trap Card that targets this card and destroy it.''',
    ...
    '''If this card is destroyed and sent to the Graveyard as a result of battle, select and Special Summon 1 @5"Troop Dragon"@7 from your Deck to your side of the field. Then shuffle your Deck.''',
    ...
    '''You can activate this card only when you have a face-up Dragon-Type monster on your side of the field. Select and activate 1 of the following effects: @4 @7Inflict 800 points of damage to your opponent's Life Points. @4 @7Destroy 1 face-up monster with a DEF of 800 points or less.''',
    ...
    '''Select one face-up Monster Card on the Field. That Monster's original ATK is halved until the End Phase.''',
    '''The ATK of this card increases by 200 points for every Fairy-Type monster in your Graveyard.''',
    '''You can only equip this card to a Fairy-Type monster. Increase the ATK of a monster equipped with this card by 500 points. When the monster equipped with this card inflicts Battle Damage to your opponent's Life Points, increase your Life Points by an equal amount.''',
    '''Offer each of your Monsters on the Field as a Tribute (except for Tokens). For each card offered as a Tribute, your opponent selects a Spell Card from their Deck, sends it to the Graveyard, and afterwards shuffles their Deck.''',
    '''FLIP: Select 1 card from your Graveyard, add it to your Deck, and shuffle your Deck.''',
    '''To activate, pay 1000 Life Points when there is 15 or more cards in your Graveyard. Each player exchanges the cards in their Graveyard with their Deck. Finally, cards from the Graveyard are shuffled and set as the Deck Zone.''',
    '''A monster that attacks this card returns to its owner's hand. Damage calculation is applied normally.''',
    '''When you Tribute Summon a monster by Tributing this card, increase the Life Points of the player who controlled this card on the field by 2000 points.''',
    ...
    '''Special Summons one Normal Monster from your Graveyard in face-up Defense Position. While that Monster is on the Field, it cannot attack.''',
    ...
    '''This card cannot be Normal Summoned or Set. This monster can only be Special Summoned by selecting 1 face-up @5"Gradius"@7 on your side of the field. The ATK and DEF of this card becomes the same as the ATK and DEF of the selected @5"Gradius"@7. If the selected @5"Gradius"@7 is removed from the field, destroy this card.''',
    ...
    '''This card cannot be Special Summoned. This card returns to the owner's hand during the End Phase of the turn that this card is Normal Summoned or flipped face-up. When this card inflicts Battle Damage to your opponent's Life Points, your opponent skips his/her next Draw Phase.''',
    ...
    '''This card cannot be Special Summoned. This card returns to the owner's hand during the End Phase of the turn that this card is Normal Summoned or flipped face-up. If this card inflicts Battle Damage to your opponent's Life Points, your opponent skips his/her next Battle Phase.''',
    ...
    '''This card cannot be Special Summoned. This card returns to the owner's hand during the End Phase of the turn that this card is Normal Summoned or flipped face-up. If this card inflicts Battle Damage to your opponent's Life Points, your opponent discards all cards in his/her hand during the next Draw Phase before he/she draws.''',
    '''This card cannot be Special Summoned. This card returns to the owner's hand during the End Phase of the turn that this card is Normal Summoned or flipped face-up. This card can attack all monsters on your opponent's side of the field. You cannot attack your opponent directly if you attack any monsters first.''',
    ...
    '''@5"Robolady"@7 + @5"Roboyarou"@7 You can Special Summon @5"Super Roboyarou"@7 by returning this card from the field to the Fusion Deck. You cannot use this effect during the same turn this monster is Special Summoned. In addition, increase the ATK of this monster by 1000 points during the Damage Step when this monster inflicts Direct Damage to your opponent's Life Points.''',
    '''@5"Roboyarou"@7 + @5"Robolady"@7 You can Special Summon @5"Super Robolady"@7 by returning this card from the field to the Fusion Deck. You cannot use this effect during the same turn this monster is Special Summoned. In addition, increase the ATK of this monster by 1000 points during the Damage Step when this monster battles with a monster.''',
    ...
    '''This card's name is treated as @5"Umi"@7. Downgrade all WATER monsters in both player's hands and on the field by 1 Level. Increase the ATK and DEF of all WATER monsters by 200 points.''',
    ...
    '''When this Equip Spell Card is active and is destroyed by a card effect, look at your opponent's hand. Select 1 card from his/her hand and discard it to the Graveyard.''',
    ...
    '''This card can only be activated during Main Phase 1. Select 1 face-up monster on the field. Each time the selected monster inflicts Battle Damage to your opponent's Life Points this turn, your opponent randomly discards 1 card.''',
    ...
    '''Remove 1 card from your opponent's Graveyard from play.''',
    ...
    '''During your Standby Phase, select 1 card randomly from your opponent's hand. Call the type of card (Monster, Spell, or Trap). If you call it right, inflict 700 points of damage to your opponent's Life Points. You can use this effect only once per turn.''',
    ...
    '''This card can only be activated during your opponent's Draw Phase. Your opponent discards the card he/she drew to the Graveyard from their hand immediately.''',
    ...
    '''This card can only be activated during your opponent's turn when your Life Points are 1000 or less. Select 1 monster on your side of the field and send all other cards on the field and in their respective owners' hands to their respective Graveyards. Your opponent then Special Summons 1 monster from his/her Deck in face-up Attack Position and attack your selected monster. (Any Battle Damage from this battle is treated as 0.) The player whose monster remains alone on the field at the End Phase of this turn wins the Duel. Any other case results in a DRAW.''',
    '''Each time this card destroys an enemy monster in battle and sends it to the Graveyard, 500 points of damage are inflicted on your opponent. Also, each time either player uses Normal Magic or Quick-Play Magic, the ATK of this card increases by 200 until the end of that turn (this effect is effective even on your opponent's turn).''',
    ...
    '''This card cannot be Special Summoned. This card returns to the owner's hand during the End Phase of the turn that this card is Normal Summoned or flipped face-up. When this card is Normal Summoned or flipped face-up, destroy all face-up monsters on the field except this card.''',
    ...
    '''You can flip this card into face-down Defense Position once per turn during your Main Phase. After you use this effect, rearrange the face-down Defense Position monsters on your side of the field, then return them in face-down Defense Position.''',
    '''When this monster destroys the following number of monsters as a result of battle, the following effects are activated in order: One: As long as this card remains face-up on the field, negate the activation and effects of all Spell and Trap Cards that target this card and destroy them. Two: You can Special Summon 1 @5"Fushioh Richie"@7 from your hand or your Deck by Tributing this card during your Main Phase.''',
    ...
    '''You can flip this card into face-down Defense Position once per turn during your Main Phase. When this card is Flip Summoned successfully, destroy 1 Spell or Trap Card on your opponent's side of the field.''',
    ...
    '''You can flip this card into face-down Defense Position once per turn during your Main Phase. When this card is Flip Summoned successfully, return all monsters on your opponent's side of the field to the owner's hand.''',
    '''When this card is sent to the Graveyard as a result of battle, you can Special Summon 1 Zombie-Type monster with a DEF 2000 or less from the Deck to the field. Then shuffle your Deck.''',
    '''FLIP: Both players roll a six-sided die once. The player with the lowest result takes damage equal to his/her opponent's result x 500 Life Points. However, if a winner's result is 6, the loser takes 6000 points of damage. If the results are the same, both players roll again.''',
    '''When this card inflicts Battle Damage to your opponent's Life Points, your opponent selects 1 Spell Card from his/her Deck and sends it to the Graveyard. Then shuffle the Deck.''',
    '''When this card inflicts Battle Damage to your opponent's Life Points, you can select and activate 1 of the following effects: @4 @7Select 1 card from your opponent's hand randomly and discard it to the Graveyard. @4 @7Send 2 cards from the top of your opponent's Deck to the Graveyard.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card can only be Special Summoned from your hand or your Deck by Tributing 1 @5"Great Dezard"@7 that has fulfilled the condition. You can flip this card into face-down Defense Position once per turn during your Main Phase. As long as this monster remains face-up on the field, negate the activation and effects of all Spell or Trap Cards that target this card and destroy them. When this card is flipped face-up, you can Special Summon 1 Zombie-Type monster from your Graveyard in face-up Attack or Defense Position.''',
    ...
    '''If there is no monster on your side of the field, you can Special Summon 1 Zombie-Type monster from your hand. You can use this effect only once per turn.''',
    '''Both players cannot destroy Set Spell and/or Trap Cards on the field until your opponent's next End Phase.''',
    '''You can select and activate 1 of the following effects: @4 @7Increase the ATK of all face-up monsters on your side of the field by 200 points until the End Phase of the turn this card is activated. @4 @7Increase the DEF of all face-up monsters on your side of the field by 500 points until the End Phase of the turn this card is activated.''',
    '''Negate the activation and the effect of a Spell or Trap Card that targets 1 face-up Zombie-Type monster and destroy it.''',
    '''You can activate this card's effect when your opponent declare an attack. Your opponent randomly selects 1 card in your hand and calls the type of the card (Monster, Spell, or Trap). If your opponent calls it wrong, the attacking monster is returned to its owner's hand.''',
    ...
    '''When this face-down card is destroyed and sent to the Graveyard, Special Summon 1 @5"Wicked Token"@7 (Fiend-Type/DARK/4 Stars/ATK 1000/DEF 1000) in Attack or Defense Position on your side of the field.''',
    '''When this face-down card is destroyed and sent to the Graveyard, your opponent selects and executes 1 of the following effects: @4 @7Discard 1 card in his/her hand randomly. @4 @7Select 1 monster on his/her side of the field and destroy it.''',
    ...
    '''You can activate this card only when your opponent has 4 or more cards in his/her hand. Look at your opponent's hand, then select 1 Monster Card and return it to its owner's Deck. Then shuffle the Deck.''',
    '''Draw 2 cards, and after that skip your next 2 Draw Phases.''',
    '''This card cannot be Special Summoned unless @5"Toon World"@7 is on your Field. If @5"Toon World"@7 is destroyed, this card is also destroyed. If your opponent controls no Toon Monsters then this card can directly attack your opponent; if your opponent controls one or more Toon Monsters then choose a Toon Monster to attack. Also, this card receives 300 extra ATK for each @5"Dark Magician"@7 and/or @5"Magician of Black Chaos"@7 in your Graveyard and your opponent's Graveyard.''',
    '''When this card is Tribute Summoned with 3 Tributes, all Monsters on your opponent's Field are destroyed.''',
    '''When this card is Tribute Summoned with 3 Tributes, all Monsters on your opponent's Field are destroyed.''',
    '''You may activate this during the Battle Phase of your turn. If you attack a monster in Defense Position with the ATK of this card reduced by 400, and this card's ATK is higher than the defending card's DEF, the difference is inflicted on the opponent as Life Points damage.''',
    '''During each Standby Phase on your turn, this card's ATK is raised by 700 points.''',
    '''When your opponent's monster attacks a Level 4 or lower Toon Monster on your side of the field, you can make the attack a direct attack to your Life Points.''',
    '''Add 1 card from your Deck to your hand that includes @5"Toon"@7 in its card name, or is named @5"Manga Ryu-Ran"@7.''',
    '''This card cannot attack during the turn that it is Normal Summoned, Flip Summoned, or Special Summoned. When @5"Toon World"@7 on the field is destroyed, destroy this card. If @5"Toon World"@7 is on your side of the field and your opponent does not control a Toon Monster, this card can attack your opponent's Life Points directly. When this card inflicts Battle Damage to your opponent's Life Points, draw 1 card from your Deck.''',
    '''This card cannot attack during the turn that it is Normal Summoned, Flip Summoned, or Special Summoned. When @5"Toon World"@7 on the field is destroyed, destroy this card. If @5"Toon World"@7 is on your side of the field and your opponent does not control a Toon Monster, this card can attack your opponent's Life Points directly. When this card inflicts Battle Damage to your opponent's Life Points, your opponent discards 1 card randomly from his/her hand.''',
    '''This card cannot attack during the turn that it is Normal Summoned, Flip Summoned, or Special Summoned. When @5"Toon World"@7 on the field is destroyed, destroy this card. If @5"Toon World"@7 is on your side of the field and your opponent does not control a Toon Monster, this card can attack your opponent's Life Points directly. Tribute 1 monster on your side of the field to inflict 500 points of damage to your opponent's Life Points.''',
    '''This card cannot attack during the turn that it is Normal Summoned, Flip Summoned, or Special Summoned. When @5"Toon World"@7 on the field is destroyed, destroy this card. If @5"Toon World"@7 is on your side of the field and your opponent does not control a Toon Monster, this card can attack your opponent's Life Points directly. If this card attacks, it is changed to Defense Position at the end of the Battle Phase, and you cannot change this Battle Position until the end of your next turn.''',
    '''Remove all cards in your hand and on your side of the field from play. Draw cards until you have 2 cards in your hand.''',
    '''When this card is successfully Tribute Summoned, you may pay 2000 Life Points to Special Summon two Fiend monsters from your Graveyard. Monsters Special Summoned by this effect cannot attack that turn.''',
    '''When this card is destroyed and sent to the Graveyard as a result of battle, destroy 1 monster on the field.''',
    '''When this card is destroyed as a result of battle and sent to the Graveyard, Special Summon 1 Plant-Type monster from your Graveyard to your side of the field, except @5"Lord Poison"@7.''',
    '''If you have 1 or less cards in your hand, increase the ATK of this card on the field by 400 points. Also, when this card is the only monster on your side of the field, negate the effects of Flip Effect Monsters destroyed by this card as a result of battle.''',
    ...
    '''Can be activated when your opponent Summons or Flip Summons a Monster. Special Summons 1 DARK monster Level 4 or lower from your Hand.''',
    '''This steel-armored terror machine ruthlessly cuts down enemies with its giant katana.''',
    '''Can be activated when your opponent's Monster attacks. Destroys all Spell and Trap cards on the Field.''',
    ...
    '''Can be activated when your opponent attacks during their Battle Step. Returns 1 Monster on your Field to your Hand and Special Summons one Level 4 Monster from your Hand.''',
    ...
    '''@5"Black Luster Soldier"@7 + @5"Blue-Eyes Ultimate Dragon"@7 This monster can only be Special Summoned with a Fusion Summon. For each Dragon monster on your Field, not including this one, this card receives a 500 point ATK bonus.''',
    '''This card can only be Special Summoned with a Fusion Summon. This card is Fusion Summoned with 5 Dragon monsters. This card does not take battle damage from EARTH, WATER, FIRE, WIND, or DARK monsters.''',
    ...
    '''Select and activate 1 of the following effects: @4 @7Change the battle position of 1 face-up monster on your opponent's side of the field. @4 @7Tribute 1 monster on your side of the field. Select 1 face-up monster on your opponent's side of the field. Take control of the selected card until the End Phase of the turn this card is activated.''',
    ...
    '''FLIP: Special Summon 1 Monster Card that includes @5"Gravekeeper's"@7 in its card name with an ATK of 1500 or less from your Deck.''',
    '''When this card is Normal Summoned, Flip Summoned, or Special Summoned, inflict 500 points of damage to your opponent's Life Points.''',
    '''FLIP: Return 1 monster on your opponent's side of the field to its owner's hand.''',
    '''When this card attacks with an ATK that is higher than the DEF of your opponent's Defense Position monster, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''Tribute 1 Monster Card on your side of the field that includes @5"Gravekeeper's"@7 in its card name to inflict 700 points of damage to your opponent's Life Points. You cannot Tribute @5"Gravekeeper's Cannonholder"@7 for this effect.''',
    '''You cannot activate this card's effect unless @5"Necrovalley"@7 is on the field. When this card declares an attack, you can change the battle position of 1 face-up monster on your opponent's side of the field.''',
    ...
    '''FLIP: Select 1 Trap Card from your Deck and place it on top of your Deck. If @5"Necrovalley"@7 is on the field, you can add the selected Trap Card to your hand instead.''',
    '''When this card is destroyed and sent to the Graveyard as a result of battle, destroy the monster that destroyed this card.''',
    '''You can return your opponent's face-up Attack Position monster that is sent to the Graveyard by this monster as a result of battle to the top of his/her Deck.''',
    '''FLIP: Select 1 Field Spell Card from your Deck and place it on top of your Deck. If @5"Necrovalley"@7 is on the field, you can add the selected Field Spell Card to your hand instead.''',
    '''Discard this card from your hand. Until the End Phase, make the Battle Damage to monsters that include @5"Gravekeeper's"@7 in their card name 0.''',
    '''FLIP: Special Summon 1 @5"Poisonous Snake Token"@7 (Reptile-Type/EARTH/3 Stars/ATK 1200/DEF 1200). When the @5"Poisonous Snake Token"@7 is destroyed as a result of battle, inflict 500 points of damage to your opponent's Life Points.''',
    '''This card is not destroyed as a result of battle. Destroy this card when it is designated as a target of the effect of a Spell, Trap, or Effect Monster. If this card successfully attacks your opponent's Life Points directly, your opponent discards 1 card randomly from his/her hand.''',
    ...
    '''@5"Spirit Reaper"@7 + @5"Nightmare Horse"@7 This card is not destroyed as a result of battle. Destroy this card when it is targeted by the effect of a Spell, Trap, or Effect Monster. This card can attack your opponent's Life Points directly even if there is a monster on your opponent's side of the field. If this card successfully attacks your opponent's Life Points directly, your opponent discards 1 card randomly from his/her hand.''',
    ...
    '''Each time damage, except Battle Damage, is inflicted to your opponent's Life Points, inflict 300 points of damage to your opponent's Life Points. This card's effect is not applied to the effect of @5"Dark Room of Nightmare"@7.''',
    ...
    '''Inflict damage to both players' Life Points during each of your Standby Phases. The first damage begins at 200 points and is doubled during each of your following Standby Phases.''',
    ...
    '''This card can only be activated when @5"Necrovalley"@7 is on your side of the field. Both players discard all Monster Cards in their hands to the Graveyard.''',
    ...
    '''Your opponent adds all cards in his/her hand to the Deck and shuffles the Deck. Your opponent then draws the same number of cards that he/she added to the Deck.''',
    '''Select 1 Monster Card that includes @5"Gravekeeper's"@7 in its card name from your Graveyard and Special Summon it. This card's activation and effect are unaffected by @5"Necrovalley"@7.''',
    ...
    '''Once per turn, during your Main Phase, if you control this card on the field, you can equip it to your @5"X-Head Cannon"@7 as an Equip Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, increase the ATK and DEF of the equipped monster by 400 points. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''@5"X-Head Cannon"@7 + @5"Y-Dragon Head"@7 This card cannot be Special Summoned except by removing from play the above cards on your side of the field; then you can Special Summon this card from your Fusion Deck (You do not use @5"Polymerization"@7). Discard 1 card from your hand to destroy 1 face-up Spell or Trap Card on your opponent's side of the field.''',
    '''Once per turn, during your Main Phase, if you control this card on the field, you can equip it to your @5"X-Head Cannon"@7 or @5"Y-Dragon Head"@7 as an Equip Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, increase the ATK and DEF of the equipped monster by 600 points. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''@5"X-Head Cannon"@7 + @5"Y-Dragon Head"@7 + @5"Z-Metal Tank"@7 This card can only be Special Summoned from your Fusion Deck by removing from play the above cards on your side of the field. (You do not use @5"Polymerization"@7). This card cannot be Special Summoned from the Graveyard. By discarding 1 card from your hand, destroy 1 card on your opponent's side of the field.''',
    '''@5"X-Head Cannon"@7 + @5"Y-Dragon Head"@7 + @5"Z-Metal Tank"@7 This card can only be Special Summoned from your Fusion Deck by removing from play the above cards on your side of the field. (You do not use @5"Polymerization"@7). This card cannot be Special Summoned from the Graveyard. By discarding 1 card from your hand, destroy 1 card on your opponent's side of the field.''',
    '''@5"X-Head Cannon"@7 + @5"Y-Dragon Head"@7 + @5"Z-Metal Tank"@7 This card can only be Special Summoned from your Fusion Deck by removing from play the above cards on your side of the field. (You do not use @5"Polymerization"@7). This card cannot be Special Summoned from the Graveyard. By discarding 1 card from your hand, destroy 1 card on your opponent's side of the field.''',
    '''Can be activated when a Monster on your Field is destroyed and sent to the Graveyard. Pay 1000 Life Points to Special Summon one Level 4 Monster from your Deck.''',
    '''While @5"Queen's Knight"@7 is on your side of the field, when this card is Normal Summoned, you can Special Summon 1 @5"Jack's Knight"@7 from your Deck.''',
    ...
    '''When this card causes battle damage to your opponent, they must send the topmost card from their Deck to the Graveyard. When this card is sent from the Field to the Graveyard, you can choose one Zombie-type card with a DEF of 1200 or less from your Deck and show it to your opponent before adding it to your Hand. The Deck is then shuffled.''',
    '''If the only cards on your opponent's side of the field are face-up monsters with ATK 1600 or more, this monster can attack your opponent's Life Points directly.''',
    '''By removing from play 2 WATER monsters in your Graveyard, Special Summon 1 @5"Lekunga Token"@7 (Plant-Type/WATER/Level 2/ATK 700/DEF 700) in Attack Position on your side of the field.''',
    ...
    '''When this card is Normal Summoned successfully, you can Special Summon 1 @5"Zombie Tiger"@7 from your hand. If this card successfully attacks your opponent's Life Points directly, your opponent discards 1 card randomly from his/her hand.''',
    '''Once per turn, during your Main Phase, if you control this card on the field, you can equip it to your @5"Decayed Commander"@7 as an Equip Spell Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, increase the ATK/DEF of the equipped monster by 500 points, and each time it destroys 1 of your opponent's monsters, your opponent discards 1 card randomly from his/her hand. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    ...
    '''Once per turn, during your Main Phase, if you control this monster on the field, you can equip it to your @5"Giant Orc"@7 as an Equip Spell Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, you can change the equipped monster's battle position once per turn. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''When this monster is Normal Summoned successfully, you can Special Summon 1 @5"Des Dendle"@7 from your hand.''',
    '''Once per turn, during your Main Phase, if you control this monster on the field, you can equip it to your @5"Vampire Orchis"@7 as an Equip Spell Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, each time the equipped monster destroys 1 of your opponent's monsters, Special Summon 1 @5"Wicked Plant Token"@7 (Plant-Type/EARTH/1 Star/ATK 800/DEF 800). (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''Once per turn, during your Main Phase, if you control this monster on the field, you can equip it to your @5"Freezing Beast"@7 as an Equip Spell Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, each time the equipped monster inflicts Battle Damage to your opponent, destroy 1 face-up Spell or Trap Card on the field. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''Once per turn, during your Main Phase, if you control this monster on the field, you can equip it to your @5"Burning Beast"@7 as an Equip Spell Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, each time the equipped monster inflicts Battle Damage to your opponent, destroy 1 face-down Spell or Trap Card on the field. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    ...
    '''This monster can only be Ritual Summoned with the Ritual Spell Card, @5"White Dragon Ritual"@7. You must also Tribute monsters whose total Levels equal 4 or more from the field or your hand. When this monster attacks a face-down Defense Position monster, destroy the face-down monster with this card's effect. You can Tribute this card to Special Summon 1 @5"Blue-Eyes White Dragon"@7 from your hand or your Deck. (@5"Blue-Eyes White Dragon"@7 cannot attack during that turn.)''',
    '''This card is used to Ritual Summon @5"Paladin of White Dragon"@7. You must also Tribute monsters whose total Levels equal 4 or more from the field or your hand.''',
    ...
    '''Select and activate 1 of the following effects: @4 @7Increase your Life Points by 1200 points. @4 @7Inflict 800 points of damage to your opponent's Life Points.''',
    '''Discard 1 card from your hand. Remove 1 face-up monster on the field from play.''',
    ...
    '''This card can only be activated during your Main Phase when @5"People Running About"@7, @5"Oppressed People"@7, and @5"United Resistance"@7 are face-up on your side of the field. Send all cards in your opponent's hand to the Graveyard and destroy all cards your opponent controls on the field.''',
    ...
    '''Select and activate 1 of the following effects: @4 @7Negate the activation and the effect of a Spell Card that targets 1 monster on the field and destroy the Spell Card. @4 @7Send 1 Spell Card from your hand to the Graveyard to negate the activation and the effect of a Spell Card and destroy it.''',
    ...
    '''Select and activate 1 of the following effects: @4 @7Equip 1 Union Monster on your side of the field to an appropriate monster on your side of the field as an Equip Spell Card.  @4 @7Unequip 1 of your equipped Union Monsters and Special Summon it to your side of the field in face-up Attack Position.''',
    '''You can only activate this card when your opponent successfully Normal Summons, Flip Summons, or Special Summons a monster(s). As long as the monster(s) remains on the field, the original ATK of the monster(s) is halved.''',
    '''@5"X-Head Cannon"@7 + @5"Z-Metal Tank"@7 This card cannot be Special Summoned except by removing from play the above cards on your side of the field; then you can Special Summon this card from your Fusion Deck (You do not use @5"Polymerization"@7). Discard 1 card from your hand to destroy 1 face-down Spell or Trap Card on your opponent's side of the field.''',
    '''@5"Y-Dragon Head"@7 + @5"Z-Metal Tank"@7 This card cannot be Special Summoned except by removing from play the above cards on your side of the field; then you can Special Summon this card from your Fusion Deck (You do not use @5"Polymerization"@7). Discard 1 card from your hand to destroy 1 face-down Monster Card on your opponent's side of the field.''',
    ...
    '''@5"Dark Magician"@7 + @5"Buster Blader"@7 This monster cannot be Special Summoned except by Fusion Summon. As long as this card remains face-up on the field, you can discard 1 card from your hand to negate the activation of a Spell Card and destroy it. Increase the ATK of this card by 500 points for each Dragon-Type monster on the field and in either player's Graveyard.''',
    '''@5"Dark Magician"@7 + @5"Buster Blader"@7 This monster cannot be Special Summoned except by Fusion Summon. As long as this card remains face-up on the field, you can discard 1 card from your hand to negate the activation of a Spell Card and destroy it. Increase the ATK of this card by 500 points for each Dragon-Type monster on the field and in either player's Graveyard.''',
    '''@5"Dark Magician"@7 + @5"Buster Blader"@7 This monster cannot be Special Summoned except by Fusion Summon. As long as this card remains face-up on the field, you can discard 1 card from your hand to negate the activation of a Spell Card and destroy it. Increase the ATK of this card by 500 points for each Dragon-Type monster on the field and in either player's Graveyard.''',
    ...
    '''Special Summons one @5"Metal Fiend Token"@7 (Fiend-Type/DARK/1 Star/ATK 0/DEF 0) to your Field. This Token cannot attack. Excess damage against the Controller from battle with @5"Metal Fiend Token"@7 is received by your opponent instead. Pay 1000 Life Points during your Standby Phase. If you do not pay 1000 Life Points, the @5"Metal Fiend Token"@7 is destroyed.''',
    ...
    '''Increase the ATK of this monster by 100 points for each monster on your side of the field that includes @5"Amazoness"@7 in its card name, or is named @5"Amazon Archer"@7.''',
    ...
    '''You can only have 1 @5"Amazoness Tiger"@7 on your side of the field. Increase the ATK of this card by 400 points for each monster on your side of the field that includes @5"Amazoness"@7 in its name, or is named @5"Amazon Archer"@7. As long as this card remains face-up on the field, your opponent cannot attack another monster that includes @5"Amazoness"@7 in its name, or is named @5"Amazon Archer"@7.''',
    '''Each time you or your opponent activates 1 Spell Card, put 1 Spell Counter on this card (max. 3). Tribute this card with 3 Spell Counters on it to Special Summon 1 @5"Buster Blader"@7 from your hand, Deck, or Graveyard.''',
    '''Each time you or your opponent activates 1 Spell Card, put 1 Spell Counter on this card (max. 3). By Tributing this card with 3 Spell Counters on it, Special Summon 1 @5"Dark Magician"@7 from your hand, Deck, or Graveyard.''',
    ...
    '''When this card inflicts Battle Damage to your opponent's Life Points, you can select and activate 1 of the following effects: @4 @7Destroy 1 Spell Card or Trap Card on the field. @4 @7Send 2 cards from the top of your opponent's Deck to his/her Graveyard.''',
    ...
    '''Add 1 @5"Gather Your Mind"@7 card from your Deck to your hand. Your Deck is then shuffled. You can only use 1 @5"Gather Your Mind"@7 per turn.''',
    ...
    '''Add 1 @5"Buster Blader"@7 from your Deck or your Graveyard to your hand.''',
    '''You can only activate this card when @5"Pot of Greed"@7 is activated. Negate the effect of the @5"Pot of Greed"@7 and draw 1 card from your Deck.''',
    ...
    '''Remove 2 Spell Counters on your side of the field. Special Summon 1 @5"Dark Magician"@7 or @5"Buster Blader"@7 from your Graveyard in face-up Attack or Defense Position.''',
    ...
    '''Discard 2 cards from your Hand to return one Spell Card from your Graveyard to your Hand.''',
    ...
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"Shinato's Ark"@7. You must also Tribute monsters whose total Levels equal 8 or more from the field or your hand. When this card destroys a Defense Position monster and sends it to the Graveyard as a result of battle, inflict damage to your opponent's Life Points equal to the original ATK of the destroyed monster.''',
    '''@5"Dark Magician"@7 + @5"Flame Swordsman"@7 Any damage to this card's controller caused as a result of battle involving this monster becomes 0. When this card is destroyed and sent to the Graveyard as a result of battle, Special Summon 1 @5"Mirage Knight"@7 from your hand or Deck.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Dark Flare Knight"@7. When this card battles another monster, during damage calculation increase the ATK of this card by the original ATK of the opponent's monster. During the End Phase after this card was involved in battle, remove this card from play.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"A Deal with Dark Ruler"@7. This card can attack all monsters on your opponent's side of the field once each. Decrease the ATK of this card by 500 points during the End Phase of each of your turns.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Contract with Exodia"@7. This card is not destroyed as a result of battle or by the effects of Spell or Trap Cards, and during each of your Standby Phases, increase the ATK of this card by 500 points. This card is destroyed when any of @5"Exodia the Forbidden One"@7, @5"Right Arm of the Forbidden One"@7, @5"Left Arm of the Forbidden One"@7, @5"Right Leg of the Forbidden One"@7 or @5"Left Leg of the Forbidden One"@7 is not in your Graveyard.''',
    '''A cyborg with high defense power. Originally it was invented for a football machine.''',
    '''FLIP: Add 1 card that includes @5"Guardian"@7 in its card name from your Deck to your hand. You cannot add @5"Celtic Guardian"@7, @5"Winged Dragon, Guardian of the Fortress #1"@7, @5"Winged Dragon, Guardian of the Fortress #2"@7, @5"Guardian of the Labyrinth"@7, @5"The Reliable Guardian"@7, or @5"Guardian Exode"@7.''',
    ...
    '''This card can only be Normal Summoned, Flip Summoned, or Special Summoned when there is a @5"Butterfly Dagger - Elma"@7 on your side of the field. When this card is Normal Summoned or Special Summoned successfully, you can equip 1 appropriate Equip Spell Card in your Graveyard to this card.''',
    '''This card can only be Normal Summoned, Flip Summoned, or Special Summoned when there is a @5"Shooting Star Bow - Ceal"@7 on your side of the field. Send an Equip Spell Card on your side of the field equipped to this card to the Graveyard to destroy 1 monster on your opponent's side of the field.''',
    '''This card can only be Normal Summoned, Flip Summoned, or Special Summoned when there is a @5"Gravity Axe - Grarl"@7 on your side of the field. If this is the only card in your hand, you can Special Summon it.''',
    '''This card can only be Normal Summoned, Flip Summoned, or Special Summoned when there is a @5"Wicked-Breaking Flamberge - Baou"@7 on your side of the field. Each time this card destroys 1 of your opponent's monsters and sends it to the Graveyard as a result of battle, increase the ATK of this card by 1000 points. Also, the effects of an Effect Monster that this card destroys as a result of battle are negated.''',
    '''This card can only be Normal Summoned, Flip Summoned, or Special Summoned when there is a @5"Rod of Silence - Kay'est"@7 on your side of the field. This card is unaffected by any Spell Cards. Also, this card cannot be an attack target of your opponent's monsters.''',
    '''This card can only be Normal Summoned, Flip Summoned, or Special Summoned when there is a @5"Twin Swords of Flashing Light - Tryce"@7 on your side of the field. When this card is destroyed and sent to the Graveyard, Special Summon to your side of the field the monster in the Graveyard that was used for the Tribute Summon of this card.''',
    ...
    '''When this card is sent from your hand or Deck to your Graveyard by your opponent's card effect, Special Summon this card to the field.''',
    '''When this card inflicts Battle Damage to your opponent's Life Points, you can select and activate 1 of the following effects: @4 @7Return 1 card on the field to its owner's hand. @4 @7Pick up 1 card on the top of your opponent's Deck (Your opponent does not look at the card). Select the top or the bottom of the Deck and return the card there.''',
    '''When this card battles with your opponent's monster, after damage calculation you can remove from play the opponent's monster and this card.''',
    ...
    '''This card is used to Ritual Summon @5"Shinato, King of a Higher Plane"@7. You must also Tribute monsters whose total Levels equal 8 or more from the field or your hand.''',
    '''You can only activate this card during a turn in which a Level 8 or higher monster on your side of the field was sent to the Graveyard. Special Summon 1 @5"Berserk Dragon"@7 from your hand or Deck.''',
    '''You can only activate this card when you have @5"Exodia the Forbidden One"@7, @5"Right Arm of the Forbidden One"@7, @5"Left Arm of the Forbidden One"@7, @5"Right Leg of the Forbidden One"@7, and @5"Left Leg of the Forbidden One"@7 in your Graveyard. Special Summon 1 @5"Exodia Necross"@7 from your hand.''',
    ...
    '''Increase the ATK of a monster equipped with this card by 500 points. As long as this card remains on the field, monsters on your opponent's side of the field cannot change their battle positions.''',
    '''Send 1 card from your hand to the Graveyard to equip this card. Increase the ATK of the equipped monster by 500 points. If a monster equipped with this card destroys a monster as a result of battle, the effect of that monster is negated.''',
    '''Increase the DEF of a monster equipped with this card by 500 points. Negate the effect of a Spell Card (excluding this card) that targets the monster equipped with this card and destroy the Spell Card.''',
    '''Send 1 card from your hand to your Graveyard to equip this card. Decrease the ATK of a monster equipped with this card by 500 points. A monster equipped with this card can attack twice during the same Battle Phase.''',
    ...
    '''Add 1 Equip Spell Card from your Graveyard to your hand. You cannot activate that Equip Spell Card this turn.''',
    ...
    '''Special Summon 3 @5"Ojama Tokens"@7 (Beast-Type/LIGHT/Level 2/ATK 0/DEF 1000) in Defense Position on your opponent's side of the field. The tokens cannot be Tributed for a Tribute Summon. When an @5"Ojama Token"@7 is destroyed, the controller of that Token takes 300 points of damage.''',
    ...
    '''Destroys 1 face-up Monster on your opponent's Field. Your opponent receives 1000 Life Points when a Monster is destroyed by this effect.''',
    ...
    '''Pay half your Life Points to select one of the following conditions and effects: @4 @7If a @5"Friendship"@7 is in your Graveyard, your opponent cannot Set, Summon, Flip Summon, Special Summon, or activate an Effect Monster until the end of the turn. @4 @7If a @5"Unity"@7 is in your Graveyard, effects from Spell and Trap Cards on your opponent's Field are cancelled, and your opponent cannot activate or set Spell or Trap Cards until the end of the turn.''',
    '''Request a handshake from your opponent. If your opponent responds with a handshake, both players Life Points becomes one half the total of their Life Points. If you have a @5"Unity"@7 in your Hand, by showing your opponent that card, they must respond with a handshake.''',
    '''Select one Monster on your Field. The selected Monster's DEF becomes the sum of the original DEF of all face-up Monsters on your Field until your End Phase.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Knight's Title"@7. If this card is Special Summoned successfully, select 1 card on the field and destroy it.''',
    '''Activate this card by offering 1 face-up @5"Dark Magician"@7 on your side of the field as a Tribute. Special Summon 1 @5"Dark Magician Knight"@7 from your hand, Deck or Graveyard.''',
    '''You can only activate this card when there is a face-up @5"Dark Magician Girl"@7 on your side of the field. Special Summon 1 @5"Dark Magician"@7 from your hand or Deck.''',
    ...
    '''As long as this card remains face-up on your side of the field, @5"Pandemonium"@7 on your side of the field is not destroyed by your opponent's card effects.''',
    ...
    '''When this card inflicts Battle Damage to your opponent's Life Points, you can select and activate 1 of the following effects: @4 @7Return 1 Monster Card on your opponent's side of the field to the top of its owner's Deck. @4 @7Send 1 card from the top of your opponent's Deck to the Graveyard.''',
    '''When this card inflicts Battle Damage to your opponent's Life Points, you can select and activate 1 of the following effects: @4 @7Add 1 card that includes @5"Dark Scorpion"@7 in its card name, or is named @5"Cliff the Trap Remover"@7, from your Deck to your hand. @4 @7Add 1 card that includes @5"Dark Scorpion"@7 in its card name, or is named @5"Cliff the Trap Remover"@7, from your Graveyard to your hand.''',
    ...
    '''The controller of this card pays 500 Life Points during each of his/her Standby Phases (this is not optional). When this card is targeted by the effect of a card controlled by your opponent, when resolving the effect, roll a six-sided die. If the result is 3, negate the effect and destroy the opponent's card. When a @5"Terrorking Archfiend"@7 on your side of the field is destroyed and sent to the Graveyard, you can send this card from your hand to the Graveyard to Special Summon the @5"Terrorking Archfiend"@7.''',
    ...
    '''This card cannot be Special Summoned. This card returns to the owner's hand during the End Phase of the turn that it is Normal Summoned or flipped face-up. When this card is Normal Summoned or flipped face-up, select 1 face-up monster on the field and flip it into face-down Defense Position.''',
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"Incandescent Ordeal"@7. You must also Tribute monsters whose total Levels equal 7 or more from the field or your hand. Each time you or your opponent activates 1 Spell Card, put 1 Spell Counter on this card. Remove 3 Spell Counters from this card to destroy all monsters on the field except this card.''',
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"Contract with the Dark Master"@7. You must also Tribute monsters whose total Levels equal 8 or more from the field or your hand. During your turn, you can roll 1 six-sided die. If the result is 1 or 2, destroy all monsters on your opponent's side of the field. If the result is 3, 4, or 5, destroy 1 monster on your opponent's side of the field. If the result is 6, destroy all monsters on your side of the field.''',
    '''This card is used to Ritual Summon @5"Legendary Flame Lord"@7. You must also Tribute monsters whose total Levels equal 7 or more from the field or your hand.''',
    '''This card is used to Ritual Summon any DARK Ritual Monster. You must also Tribute monsters from the field or your hand whose total Levels equal the Level of the Ritual Monster you are Ritual Summoning.''',
    '''This card is used to Ritual Summon @5"Dark Master - Zorc"@7. You must also Tribute monsters whose total Levels equal 8 or more from the field or your hand.''',
    '''Destroy this card if there is no Archfiend card on your side of the field. Take control of 1 of your opponent's monsters that is equipped with this card. You take 800 points of damage during each of your opponent's Standby Phases.''',
    '''Tribute 1 Archfiend monster on your side of the field. During this turn, 1 @5"Terrorking Archfiend"@7 on your side of the field can attack your opponent's Life Points directly.''',
    ...
    '''You can only activate this card when there is a face-up @5"Don Zaloog"@7(s) on your side of the field. You can Special Summon from your hand any of the cards that include @5"Dark Scorpion"@7 in their card name, or are named @5"Cliff the Trap Remover"@7. (You can only Special Summon up to 1 card with each card name.)''',
    ...
    '''You can only activate this card when there are @5"Don Zaloog"@7, @5"Cliff the Trap Remover"@7, @5"Dark Scorpion - Chick the Yellow"@7, @5"Dark Scorpion - Gorg the Strong"@7, and @5"Dark Scorpion - Meanae the Thorn"@7 face-up on your side of the field. During this turn, any of these 5 cards can attack your opponent's Life Points directly. In that case, the Battle Damage inflicted to your opponent by each of those cards becomes 400 points.''',
    ...
    '''Once this turn, negate 1 six-sided die roll and re-roll it.''',
    ...
    '''FLIP: Select 1 Trap Card on the field and destroy it. If the selected card is Set, pick up and look at the card. If it is a Trap Card, destroy it. If it is a Spell Card, return it to its original position.''',
    ...
    '''FLIP: Select 1 Monster Card on your opponent's side of the field and return it to its owner's hand.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card can only be Special Summoned by removing from play 1 FIRE monster in your Graveyard. When this card destroys an opponent's monster as a result of battle and sends it to the Graveyard, inflict 1500 points of damage to your opponent's Life Points.''',
    ...
    '''The ATK and the DEF of this card become the number of your cards that are removed from play x 400 points.''',
    '''This card cannot be Normal Summoned or Set. This card can only be Special Summoned by removing from play 1 LIGHT and 1 DARK monster in your Graveyard. Once during each of your turns, you can select and activate 1 of the following effects: @4 @7Remove from play 1 monster on the field. If you activate this effect, this card cannot attack during this turn. @4 @7If this card destroyed your opponent's monster as a result of battle, it can attack once again in a row.''',
    '''You can only equip this card to a monster that includes @5"Ninja"@7 in its card name. Increase the ATK of the equipped monster by 700 points. When this card is sent from the field to the Graveyard, inflict 700 points of damage to your opponent's Life Points.''',
    ...
    '''You can only activate this card while @5"Ojama Green"@7, @5"Ojama Yellow"@7 and @5"Ojama Black"@7 are face-up on your side of the field. Destroy all cards on your opponent's side of the field.''',
    ...
    '''You can only activate this card if there is a @5"Black Luster Soldier - Envoy of the Beginning"@7 or @5"Chaos Emperor Dragon - Envoy of the End"@7 on the field. Add 2 of your removed from play cards to your hand.''',
    ...
    '''Each time a card(s) is removed from play, increase your Life Points by 500 points for each card removed from play.''',
    ...
    '''You can only activate this card when a monster with an ATK of 1000 or less is Normal Summoned, Flip Summoned or Special Summoned. Remove from play the monster, and your opponent removes from play all monsters of the same name in their hand and Deck. Their Deck is then shuffled.''',
    '''Change the battle positions of all face-up monsters on the field.''',
    '''You can only activate this card when your opponent's monster declares an attack. Remove from play all monsters in Defense Position on your opponent's side of the field.''',
    ...
    '''This card cannot be Special Summoned. You must sacrifice 3 Dragon Monster Cards from your Field and Tribute Summon it. If you use this card to reduce your opponent's Life Points to 0 in a direct attack, the controller of this card wins the match.''',
    '''As long as this monster remains face-up on the field, your opponent cannot select another Spellcaster-Type monster on your side of the field as an attack target.''',
    ...
    '''When this card is Special Summoned from the Graveyard, the controller of this card draws 1 card.''',
    ...
    '''During battle between attacking Beast, Beast-Warrior or Winged Beast-Type monsters on your side of the field and a Defense Position monster whose DEF is lower than the ATK of the attacking monster, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''When this card is Normal Summoned or Flip Summoned, you can Special Summon any number of @5"Don Turtle"@7(s) from your hand.''',
    ...
    '''As long as @5"Umi"@7 remains face-up on the field, this card can attack your opponent's Life Points directly.''',
    '''While @5"Umi"@7 is face-up on the field, this card is unaffected by any Spell Cards.''',
    '''Send @5"Umi"@7 on your side of the field to the Graveyard to destroy all cards on the field except this card.''',
    '''By tributing 1 @5"Torpedo Fish"@7 on your side of the field, destroy 1 monster on the field. By Tributing 1 @5"Cannonball Spear Shellfish"@7 on your side of the field, destroy 1 Spell or Trap Card on the field.''',
    '''While @5"Umi"@7 is face-up on the field, this card is unaffected by any Spell Cards.''',
    ...
    '''If a monster that battles with this monster is a Fiend or Zombie-Type monster, destroy that monster at the end of the Damage Step.''',
    ...
    '''If you activate this card, you cannot Normal Summon, Flip Summon or Special Summon during this turn. Special Summon 2 @5"Lamb Tokens"@7 (Beast-Type/EARTH/Level 1/ATK 0/DEF 0) in Defense Position on your side of the field.''',
    ...
    '''You can only activate this card by Tributing @5"Dark Magician"@7 on your side of the field. Select 1 @5"Dark Magician of Chaos"@7 from your hand, your Graveyard or your Deck and Special Summon it.''',
    '''Add 2 WATER monsters with an ATK of 1500 or less each in your Graveyard to your hand.''',
    '''Tribute 1 Reptile-Type monster on your side of the field. Special Summon 1 Dinosaur-Type Monster from your hand.''',
    '''This card is used to Ritual Summon any EARTH Ritual Monster. You must also Tribute monsters from the field or your hand whose total Levels equal the Level of the Ritual Monster you are attempting to Ritual Summon.''',
    ...
    '''You can only activate this card when your opponent declares an attack. Select 1 random card from your hand. If it is a Monster Card, Special Summon it on your side of the field. If not, send it to the Graveyard.''',
    ...
    '''Declare 1 Attribute when you activate this card. While this card is face-up on the field, the Attribute of all face-up monsters on the field becomes the one you declared.''',
    '''Each time 1 monster on your side of the field inflicts Battle Damage to your opponent's Life Points, your opponent sends 1 card from the top of their Deck to the Graveyard.''',
    ...
    '''When this card is activated it turns into a Monster Card (Zombie-Type/DARK/4 Star/ATK 1800/DEF 500) and is Special Summoned onto your Monster Card Zone in Defense Position. If this card is destroyed in battle, it reduces your opponent's Life Points by the same amount as the ATK of the monster by which it was destroyed. (This card is also treated as a Trap Card).''',
    '''When this card is successfully Tribute Summoned, you may throw the dice once. The ATK of this card increases by 200 times the value of the dice as long as it remains in face-up position on the Field.''',
    '''Roll a die during each of your Standby Phases. Apply the effect that matches the number rolled as follows: 1) You discard one card from your Hand. 2) Your opponent discards one card from their Hand. 3) You draw one card. 4) Your opponent draws a card. 5) Destroy one card on your opponent's Field. 6) Destroy this card.''',
    '''Choose 2 numbers from 1 to 6. Your opponent rolls a die, and if the number rolled matches one of your chosen numbers, you draw that many cards. If the number rolled does not match one of your chosen numbers, send that many cards from the Deck to the Graveyard.''',
    ...
    '''If your Life Points are higher than your opponent's Life Points, activate this card's effect by Tributing this card from your side of the field. Inflict damage to your opponent's Life Points equal to the difference between your and your opponent's Life Points. If @5"The Sanctuary in the Sky"@7 is not on your side of the field, this effect is not applied. When you activate this effect, you cannot conduct your Battle Phase this turn.''',
    ...
    '''By paying 500 Life Points, select 1 @5"Mystical Shine Ball"@7 from your hand or Deck, and Special Summon it to your side of the field.''',
    '''This card is unaffected by any Spell Cards. While @5"The Sanctuary in the Sky"@7 is on your side of the field, and your Life Points are higher than your opponent's Life Points, increase the ATK and DEF of this card by the difference between your and your opponent's Life Points.''',
    ...
    '''While there is another Zombie-Type monster on your side of the field, your opponent cannot select this card as an attack target. Each time a Zombie-Type monster(s) is Special Summoned, send 2 cards from the top of your opponent's Deck to the Graveyard.''',
    '''When this card is Special Summoned, you can equip 1 appropriate Equip Spell Card from your Graveyard to this card.''',
    '''Each time this card inflicts Battle Damage to your opponent's Life Points, declare 1 card type (Monster, Spell, or Trap). Your opponent selects 1 card of that type from their Deck and sends it to the Graveyard.''',
    ...
    '''By sending 1 @5"Pot of Greed"@7 from your hand to the Graveyard, draw 3 cards from your Deck.''',
    ...
    '''As long as @5"Umi"@7 remains face-up on the field, this card can attack twice during the same Battle Phase.''',
    ...
    '''While there is another Fiend-Type monster on your side of the field, this card cannot be attacked. The ATK and DEF of this card become the number of Fiend-Type monsters on the field (excluding this card) x 1000 points.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 1 face-up @5"Warrior of Zera"@7 on your side of the field while @5"The Sanctuary in the Sky"@7 is on the field. If @5"The Sanctuary in the Sky"@7 is on your side of the field, by discarding 1 LIGHT Monster Card from your hand to the Graveyard, destroy all monsters on your opponent's side of the field. If @5"The Sanctuary in the Sky"@7 is not on your side of the field, this effect is not applied.''',
    ...
    '''Tribute 1 monster on your side of the field and select its ATK or DEF. Increase your Life Points by the same amount.''',
    '''You can only activate this card while there is a face-up @5"Blue-Eyes White Dragon"@7 on your side of the field. Destroy all monsters on your opponent's side of the field. No @5"Blue-Eyes White Dragon"@7 can attack during the turn you activate this card.''',
    ...
    '''Activate this card by discarding 1 LIGHT Monster Card from your hand to the Graveyard while @5"The Sanctuary in the Sky"@7 is on the field. Select 1 card on the field controlled by your opponent or 1 card in your opponent's hand (you can look at your opponent's hand), and send it to the Graveyard.''',
    ...
    '''This card cannot be Normal Summoned or Set.  This card cannot be Special Summoned except by Tributing 1 face-up @5"Warrior of Zera"@7 on your side of the field while @5"Pandemonium"@7 is on the field. If @5"Pandemonium"@7 is on your side of the field when you Special Summon this card, your opponent discards 3 random cards from their hand. If @5"Pandemonium"@7 is not on your side of the field, this effect is not applied.''',
    '''When this card is attacked while face-down, the attacker's controller receives 1000 damage after damage is calculated. This card cannot be destroyed during battle (calculated damage is applied).''',
    '''This card cannot be Special Summoned. When the effects of an Effect Monster are activated, this card must be given in Tribute if it is face-up on the Field. It cancels the activation and effects of the Effect Monster, destroying it.''',
    '''Select 1 Monster in Defense Position on the Field and destroy it.''',
    '''During your Standby Phase, if this card is in the Graveyard and you have no cards in your Hand, you may add this card to your Hand by paying 500 Life Points.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"The First Sarcophagus"@7. When this card is Special Summoned, you can Special Summon up to 4 Level 2 or lower Zombie-Type Normal Monsters from your Graveyard.''',
    ...
    '''While this card is face-up on the field, your opponent cannot draw a card(s) except during Draw Phases.''',
    ...
    '''FLIP: Flip 1 face-up monster on the field into face-down Defense Position. You cannot select @5"Desertapir"@7.''',
    ...
    '''When this card is sent directly from your hand to the Graveyard by an effect of a card controlled by your opponent, increase your Life Points by 2000 points.''',
    ...
    '''If you Tribute Summon a DARK monster, you can treat this 1 monster as 2 Tribute Monsters for the Tribute Summon.''',
    '''When this card is sent from your hand to the Graveyard by an effect of a card controlled by your opponent, return this card from the Graveyard to your hand.''',
    ...
    '''You can substitute this card for any 1 Fusion Material Monster. When you do this, the other Fusion Material Monster(s) must be the correct one(s). Discard this card from your hand to the Graveyard to add a @5"Polymerization"@7 from your Deck to your hand. The Deck is then shuffled.''',
    ...
    '''When there are 3 face-up @5"7"@7 cards on your side of the field, draw 3 cards from your Deck. Then destroy all @5"7"@7 cards. When this card is sent directly from the field to your Graveyard, increase your Life Points by 700 points.''',
    ...
    '''You can only activate this card while there is a face-up @5"Dark Magician"@7 on your side of the field. Destroy all Spell and Trap Cards on your opponent's side of the field.''',
    ...
    '''This card can only be placed on the field by the effect of @5"The First Sarcophagus"@7.''',
    '''This card can only be placed on the field by the effect of @5"The First Sarcophagus"@7.''',
    '''During each of your opponent's End Phases, place 1 card face-up on your side of the field from your hand or Deck in this order: @5"The Second Sarcophagus"@7, @5"The Third Sarcophagus"@7. If 1 Sarcophagus card is removed from your side of the field, all of them on your side of the field are sent to the Graveyard. When you have all 3 Sarcophagus cards on your side of the field, send all Sarcophagus cards on your side of the field to the Graveyard to Special Summon 1 @5"Spirit of the Pharaoh"@7 from your hand or Deck.''',
    ...
    '''This card cannot be Special Summoned. By paying half your Life Points you can destroy all the cards on the Field except this one, removing them from the game. For each card destroyed by this effect, the ATK of this card increases by 300 points. This card is sent to the Graveyard during the End Phase of the turn in which it was Summoned/Flip Summoned.''',
    '''Pay half your Life Points. Special Summon as many of your monsters as possible that have been removed from play on your side of the field. During the End Phase, remove from play all monsters that were Special Summoned by this effect.''',
    '''If this face-up card is removed from your side of the field, destroy @5"Andro Sphinx"@7 and @5"Sphinx Teleia"@7 on your side of the field and remove them from play.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by offering 1 @5"Blue-Eyes Ultimate Dragon"@7 on your side of the field as a Tribute. Increase the ATK of this card by 300 points for each Dragon-Type monster in your Graveyard. You can negate the effect of Spell, Trap, and Monster Cards that designate this card.''',
    ...
    '''When this card is sent to your Graveyard, you can remove this card from the Graveyard to Special Summon 1 @5"Peten the Dark Clown"@7 from your hand or Deck.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Horus the Black Flame Dragon LV6"@7. As long as this card remains face-up on your side of the field, you can negate the activation and effect of any Spell Cards and destroy them.''',
    '''FLIP: Draw 1 card from your Deck. Also, during your Standby Phase, send this face-up card to the Graveyard to Special Summon 1 @5"Dark Mimic LV3"@7 from your hand or Deck.''',
    '''If this card is sent to the Graveyard as a result of battle, the controller of this card draws 1 card from his/her Deck. If this card was Special Summoned by the effect of @5"Dark Mimic LV1"@7, he/she draws 2 cards instead.''',
    '''If this card attacks a face-down Defense Position monster, destroy the monster immediately with this card's effect without flipping it face-up or applying damage calculation. During the End Phase of a turn that this card destroyed a monster as a result of battle, by sending this card to the Graveyard, Special Summon 1 @5"Mystic Swordsman LV4"@7 from your hand or Deck.''',
    '''If you Normal Summon this card, you must place it in face-down Defense Position. If this card attacks a face-down Defense Position monster, destroy the monster immediately with this card's effect without flipping it face-up or applying damage calculation. During the End Phase of a turn that this card destroyed a monster as a result of battle, by sending this card to the Graveyard, Special Summon 1 @5"Mystic Swordsman LV6"@7 from your hand or Deck.''',
    '''During your Standby Phase, by sending this face-up card to the Graveyard, Special Summon 1 @5"Armed Dragon LV5"@7 from your hand or Deck.''',
    '''By sending 1 Monster Card from your hand to the Graveyard, destroy 1 face-up monster on your opponent's side of the field with an ATK equal to or less than the ATK of the sent monster. During the End Phase of a turn that this card destroyed a monster as a result of battle, by sending this card to the Graveyard, Special Summon 1 @5"Armed Dragon LV7"@7 from your hand or Deck.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Armed Dragon LV5"@7. By sending 1 Monster Card from your hand to the Graveyard, destroy all face-up monsters on your opponent's side of the field with ATK equal to or less than the ATK of the sent monster.''',
    '''As long as this card remains face-up on your side of the field, your opponent cannot designate @5"Horus the Black Flame Dragon"@7 (of any LV) as the target of the effect of a Spell, Trap, or Monster Card.''',
    '''Send this face-up card on your side of the field to the Graveyard to Special Summon 1 @5"Red-Eyes B. Dragon"@7 from your hand.''',
    ...
    '''FLIP: Take control of 1 face-up monster on your opponent's side of the field until the end of the turn.''',
    '''Increase the ATK of this card by 1000 points for each FIRE monster on the field other than this card. Send a FIRE monster other than this card to the Graveyard to inflict 500 points of damage to your opponent's Life Points.''',
    '''When this card is Tribute Summoned successfully, you can destroy up to 2 Spell or Trap Cards on the field.''',
    '''This monster gets the following effect(s) while there is a monster(s) with the following Attribute(s) on the field: @4 @7FIRE: Increase the ATK of this card by 500 points. @4 @7WIND: If this card destroyed your opponent's monster as a result of battle, it can attack once again in a row.''',
    '''This monster gets the following effect(s) while there is a monster(s) with the following Attribute(s) on the field: @4 @7WATER: Control of this card cannot switch. @4 @7EARTH: Negate the effect of an Effect Monster that is destroyed by this monster as a result of battle.''',
    '''When this card is destroyed and sent to the Graveyard as a result of battle, you can Special Summon 1 Insect-Type monster with an ATK of 1500 or less to your side of the field from your Deck. Then shuffle your Deck.''',
    ...
    '''As long as this card remains face-up on the field, your opponent must continue to show his/her hand.''',
    '''If you Tribute Summon a WATER monster, you can treat this 1 monster as 2 Tribute Monsters for the Tribute Summon.''',
    ...
    '''Increase the ATK and DEF of this card by 400 points for each card in your hand.''',
    ...
    '''@5"Ojama Green"@7 + @5"Ojama Yellow"@7 + @5"Ojama Black"@7 Select up to 3 of your opponent's Monster Card Zones. As long as this card remains face-up on the field, the selected zones cannot be used.''',
    '''@5"Big Koala"@7 + @5"Des Kangaroo"@7''',
    '''@5"Sangan"@7 + @5"Witch of the Black Forest"@7''',
    ...
    '''You can only activate this card if your opponent has 3 or less cards in his/her hand. Your opponent adds his/her hand to the Deck and shuffles it, then draws the same of number of cards he/she added to the Deck.''',
    ...
    '''Send 1 face-up monster on your side of the field that has @5"LV"@7 in its card name to the Graveyard to activate this card. Special Summon the monster that is written in the card text of that monster from your hand or Deck, ignoring the Summoning conditions.''',
    '''Select 1 face-up @5"Red-Eyes B. Dragon"@7 on your side of the field to activatre this card. Inflict damage to your opponent's Life Points equal to the original ATK of the selected @5"Red-Eyes B. Dragon"@7. @5"Red-Eyes B. Dragon"@7 cannot attack during the turn you use this card.''',
    '''Add 2 monsters in your Graveyard that have @5"LV"@7 in their card name to your Deck and shuffle it.''',
    '''During each player's End Phase, each player can Special Summon 1 Level 4 Normal Monster from his/her hand.''',
    ...
    '''During your opponent's Main Phase 1, select 1 monster on your side of the field to activate this card. As long as the selected card remains on the field, if your opponent attacks with a monster(s) this turn, he/she must select the selected monster as the attack target.''',
    ...
    '''Select 1 face-up monster on your side of the field that includes @5"Ninja"@7 in its card name to activate this card. As long as this card remains face-up on the field, the selected monster is not destroyed as a result of battle (damage calculation is applied normally).''',
    '''Your opponent's hand size limit becomes 5.''',
    '''You can only activate this card when your opponent has 8 or more cards in his/her hand. Your opponent adds his/her hand to the Deck, shuffles it, and draws 2 cards.''',
    ...
    '''This card can be Special Summoned from your Hand by discarding one other card from your Hand.''',
    '''When this card is Summoned or Special Summoned successfully, you may add one @5"Red Gadget"@7 card from your Deck to your Hand.''',
    '''After activating this card, it becomes a Monster Card (Machine-Type/EARTH/4 Star/ATK 0/DEF 2000) and is Special Summoned into your Monster Card Zone in Defense Position. This card will have 3000 ATK Points if the cards @5"Green Gadget,"@7 @5"Red Gadget,"@7 and @5"Yellow Gadget"@7 are all face up on your Field. (This card is also treated as a Trap Card).''',
    '''After activating this card, it becomes a Monster Card (Machine-Type/EARTH/4 Star/ATK 0/DEF 2000) and is Special Summoned into your Monster Card Zone in Defense Position. This card will have 3000 ATK Points if the cards @5"Green Gadget,"@7 @5"Red Gadget,"@7 and @5"Yellow Gadget"@7 are all face up on your Field. (This card is also treated as a Trap Card).''',
    '''When this card is Summoned or Special Summoned successfully, you may add one @5"Yellow Gadget"@7 card from your Deck to your Hand.''',
    '''When this card is Summoned or Special Summoned successfully, you may add one @5"Green Gadget"@7 card from your Deck to your Hand.''',
    '''Activate by sending one @5"The Tricky"@7 card that is face up on your field to the Graveyard. When activating this card, only the monsters that are in your opponent's field are Special Summoned in Defensive Position as @5"Tricky Tokens"@7 (Spellcaster-Type/WIND/5 Star/ATK 2000/DEF 1200). These Tokens cannot declare an attack.''',
    '''This card is given as a Tribute. This card is used to Special Summon the @5"Block Token"@7 (Rock-Type/EARTH/4 Star/ATK 1000/DEF 1500) in Defense Position for the same number of turns as this card existed on your Field in face-up position before the Summon. This Token cannot declare an attack.''',
    '''Negate the effects of your opponent's Spell Cards that designate this card. During your Standby Phase, send this face-up card to the Graveyard to Special Summon 1 @5"Silent Swordsman LV5"@7 from your hand or Deck. (You cannot activate this effect the turn this card is Normal Summoned, Special Summoned, or flipped face-up.)''',
    '''This card is unaffected by your opponent's Spell Cards. If this card successfully attacks your opponent's Life Points directly, during your next Standby Phase, send this face-up card to the Graveyard to Special Summon 1 @5"Silent Swordsman LV7"@7 from your hand or Deck.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Silent Swordsman LV5"@7. As long as this card remains face-up on your side of the field, negate the effects of all Spell Cards on the field.''',
    '''Each time your opponent draws a card(s), put 1 Spell Counter on this card (max. 5). Increase the ATK of this card by 500 points for each Spell Counter on this card. If 5 Spell Counters are on this card, during the Standby Phase of your next turn, by sending this face-up card with 5 Spell Counters on it to the Graveyard, Special Summon 1 @5"Silent Magician LV8"@7 from your hand or Deck.''',
    '''You can only activate this card when a Spellcaster-Type monster declares an attack. Each player selects 1 Spellcaster-Type monster from their Deck with an ATK of 2000 or less, and Special Summons it in face-up Attack Position to their side of the field.''',
    '''If there are 2 or more face-up Attack Position Spellcaster-Type monsters on your side of the field, select 1 of them and activate this card. The ATK of the selected Spellcaster-Type monster becomes 3000 points until the end of this turn. The Spellcaster-Type monster(s) that you did not selected cannot attack during this turn.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Silent Magician LV4"@7. This card is unaffected by the effects of your opponent's Spell Cards.''',
    ...
    '''Tribute this card to Special Summon 1 @5"The Creator"@7 from your hand.''',
    '''If this card was Special Summoned by the effect of @5"Ultimate Insect LV1"@7, as long as this card remains on the field, decrease the ATK of all your opponent's monsters by 300 points. During your Standby Phase, send this face-up card to the Graveyard to Special Summon 1 @5"Ultimate Insect LV5"@7 from your hand or Deck. (You cannot activate this effect the turn this card is Normal Summoned, Special Summoned, or flipped face-up.)''',
    ...
    '''This monster gets the following effect(s) while there is a monster(s) with the following Attribute(s) on the field: @4 @7WATER: Control of this card cannot switch. @4 @7WIND: If this card destroyed your opponent's monster as a result of battle, it can attack once again in a row.''',
    '''This monster gets the following effect(s) while there is a monster(s) with the following Attribute(s) on the field: @4 @7FIRE: Increase the ATK of this card by 500 points. @4 @7EARTH: Negate the effect of an Effect Monster that is destroyed by this monster as a result of battle.''',
    ...
    '''This card's name is treated as @5"Harpie Lady"@7. As long as this card remains on the field, increase the ATK of all WIND monsters by 300 points.''',
    '''This card's name is treated as @5"Harpie Lady"@7. Negate the effects of any Flip Effect Monsters that are destroyed by this monster as a result of battle.''',
    '''This card's name is treated as @5"Harpie Lady"@7. Your opponent's monster that battles with this card cannot declare an attack for your opponent's next 2 turns.''',
    ...
    '''FLIP: Draw 1 card. If you have face-up @5"Bokoichi the Freightening Car"@7 card(s) on your side of the field, draw an additional card for each of them.''',
    ...
    '''@5"Dark Blade"@7 + @5"Pitch-Dark Dragon"@7 Each time this card inflicts Battle Damage to your opponent, you can select up to 3 Monster Cards from your opponent's Graveyard and remove them from play.''',
    '''@5"Mokey Mokey"@7 + @5"Mokey Mokey"@7 + @5"Mokey Mokey"@7 When this card is removed from the field, you can Special Summon as many @5"Mokey Mokey"@7 as possible from your Graveyard.''',
    ...
    '''When @5"Harpie Lady"@7 or @5"Harpie Lady Sisters"@7 is Normal Summoned or Special Summoned to the field, destroy 1 Spell or Trap Card on the field. Increase the ATK and DEF of all face-up Winged Beast-Type monsters on the field by 200 points.''',
    '''Until the End Phase of this turn, the ATK of all @5"Harpie Lady Sisters"@7 becomes 2700, your opponent cannot activate any Trap Cards, and the effect of every Trap Card on your opponent's side of the field is negated.''',
    '''When a monster on your side of the field equipped with this card is destroyed as a result of battle, and this card is sent to the Graveyard, select and activate 1 of the following effects: @4 @7Draw 1 card from your Deck. @4 @7Randomly discard 1 card from your opponent's hand to the Graveyard.''',
    ...
    '''While a face-up @5"Mokey Mokey"@7 is on your side of the field, if a Fairy-Type monster on your side of the field is destroyed, the ATK of all @5"Mokey Mokey"@7 on your side of the field becomes 3000 until the End Phase of this turn.''',
    ...
    '''You can only activate this card when there are at least 1 monster each of WIND, WATER, FIRE and EARTH Attributes face-up on the field. Select and apply 1 of the following effects: @4 @7Destroy all monsters on your opponent's side of the field. @4 @7Destroy all Spell and Trap Cards on your opponent's side of the field. @4 @7Randomly discard 2 cards from your opponent's hand. @4 @7Draw 2 cards.''',
    ...
    '''This card cannot be destroyed during battle. When this card is face up in Attack Position, sacrificing one Monster on your Field that is level 5 or below will inflict damage on your opponent's Life Points equal to that monster's original ATK. This effect can only be used once per turn.''',
    '''Control of each Monster on the Field returns to its original owner.''',
    ...
    '''Tribute 2 monsters on your side of the field, including this card, to Special Summon 1 @5"Sacred Phoenix of Nephthys"@7 from your hand or Deck.''',
    '''If this card was Special Summoned by the effect of @5"Ultimate Insect LV3"@7, as long as this card remains on the field, decrease the ATK of all your opponent's monsters by 500 points. During your Standby Phase, send this face-up card to the Graveyard to Special Summon 1 @5"Ultimate Insect LV7"@7 from your hand or Deck. (You cannot activate this effect the turn this card is Normal Summoned, Special Summoned, or flipped face-up.)''',
    '''When this card is Tribute Summoned successfully, destroy 1 face-down card on the field.''',
    '''This monster gets the following effect(s) while there is a monster(s) with the following Attribute(s) on the field: @4 @7FIRE:Increase the ATK of this card by 500 points.  @4 @7WATER:Control of this card cannot switch.''',
    '''This monster gets the following effect(s) while there is a monster(s) with the following Attribute(s) on the field: @4 @7EARTH: Negate the effect of an Effect Monster that is destroyed by this monster as a result of battle. @4 @7WIND:If this card destroyed your opponent's monster as a result of battle, it can attack once again in a row.''',
    '''As long as this card remains face-up on the field, each time a Beast-Type monster(s) on the field is destroyed, increase the ATK of this card by 500 points.''',
    '''This card cannot be attacked if there is another Beast-Type monster on your side of the field. Make the DEF of 1 monster on your opponent's side of the field 0 until the End Phase. This effect can only be used once per turn.''',
    ...
    '''When this card is sent to the Graveyard as a result of battle, you can Special Summon any @5"Hyena"@7(s) from your Deck to the field. Then shuffle your Deck.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Release Restraint"@7. When this card is equipped with an Equip Card, destroy 1 monster on your opponent's side of the field.''',
    ...
    '''If the only cards on your opponent's Monster Card Zones are Defense Position monsters, this card can attack your opponent's Life Points directly.''',
    ...
    '''You can substitute this card for any 1 Fusion-Material Monster. When you do this, the other Fusion-Material Monster(s) must be the correct one(s). Tribute Fusion-Material Monsters on the field, including this card, to Special Summon 1 EARTH Fusion Monster from your Fusion Deck.''',
    '''If you Tribute Summon a WIND monster, you can treat this 1 monster as 2 Tribute Monsters for the Tribute Summon.''',
    '''If you Tribute Summon a FIRE monster, you can treat this 1 monster as 2 Tribute Monsters for the Tribute Summon.''',
    '''As long as this card remains face-up on the field, each time a Winged Beast-Type monster(s) on your side of the field is destroyed, increase the ATK of this card by 500 points.''',
    ...
    '''@5"Barrel Dragon"@7 + @5"Blowback Dragon"@7  Toss a coin 3 times. Destroy a number of monsters on the field equal to the number of Heads. This effect can only be used once per turn, during your Main Phase.''',
    '''@5"Lord of D."@7+@5"Divine Dragon Ragnarok"@7  As long as this card remains face-up on the field, your opponent cannot designate Dragon-Type monsters as a target of the effect of a Spell, Trap, or Monster Card. Once per turn, you can Special Summon 1 Dragon-Type monster from your hand to your side of the field.''',
    '''Discard 1 card from your hand. Select 1 card from your Graveyard and return it to the top of your Deck.''',
    '''Each time a Beast-Type monster inflicts Battle Damage to your opponent's Life Points, inflict 500 points of damage to your opponent's Life Points.''',
    '''When you activate this card, change all monsters on your opponent's side of the field to face-down Defense Position. While this card is face-up on the field, monsters on your opponent's side of the field cannot change their battle positions, except with a card effect. Destroy this card during your 2nd Standby Phase after activation.''',
    '''When @5"Gaia The Fierce Knight"@7, @5"Swift Gaia the Fierce Knight"@7 or @5"Gaia the Dragon Champion"@7 on your side of the field attacks a Defense Position monster, if the ATK of that card is higher than the DEF of the Defense Position monster, inflict the difference as Battle Damage to your opponent's Life Points. If @5"Gaia the Dragon Champion"@7 inflicts Battle Damage with this effect, draw 2 cards from your Deck and discard 1 card from your hand.''',
    '''Tribute 1 @5"Gearfried the Iron Knight"@7 on your side of the field to Special Summon 1 @5"Gearfried the Swordmaster"@7 from your hand or Deck.''',
    ...
    '''Pay 800 Life Points. Select 1 Fusion Monster from your Graveyard, Special Summon it to your side of the field and equip it with this card. When this card is destroyed, remove the equipped monster from play.''',
    ...
    '''Draw a number of cards from your Deck equal to the number of @5"Good Goblin Housekeeping"@7 cards in your Graveyard +1, select 1 card from your hand, and return it to the bottom of your Deck.''',
    ...
    '''Discard 1 card from your hand. No Trap Cards can be activated until the End Phase of this turn.''',
    '''When this card is destroyed in battle and sent to the Graveyard, you can pay 500 Life Points and Special Summon it to your Field during the Standby Phase of the next turn. When this card is successfully Special Summoned using this effect, its ATK increases by 500 points.''',
    '''Activate by selecting 1 Monster face-up on your Field. During the Battle Phase of this turn, the selected Monster's ATK is increased in an amount equal to the total ATK of every other Monster face-up in Attack Position on your Field. This monster cannot inflict battle damage against your opponent. Additionally, other Monsters in face-up Attack Position cannot attack.''',
    '''Each time you inflict battle damage on your opponent with this card, the top card of your opponent's Deck is sent to the Graveyard.''',
    '''Activate by selecting 1 Zombie-Type Monster with 2000 ATK or less on your Field. The selected Monster will be able to directly attack your opponent during the turn.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 1 @5"Red-Eyes B. Dragon"@7 on your side of the field. Increase the ATK of this card by 300 points for each Dragon-Type monster in your Graveyard.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by removing 1 @5"Vampire Lord"@7 on your side of the field from play. Discard 1 Zombie-Type monster from your hand to the Graveyard to select and Special Summon 1 Zombie-Type monster from your Graveyard with a Level less than the discarded Zombie-Type monster. You can only use this effect once per turn.''',
    '''Tribute this card to Special Summon 1 @5"Blue-Eyes White Dragon"@7 from your hand.''',
    ...
    '''If this card was Special Summoned by the effect of @5"Ultimate Insect LV5"@7, as long as this card remains face-up on your side of the field, decrease the ATK and DEF of all your opponent's monsters by 700 points.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 1 @5"Monk Fighter"@7 on your side of the field. This card can attack twice during the same turn.''',
    ...
    '''FLIP: Destroy 1 Defense Position monster on the field.''',
    ...
    '''FLIP: Take control of 1 WATER monster on your opponent's side of the field, for as long as this card remains face-up on the field.''',
    '''FLIP: Take control of 1 FIRE monster on your opponent's side of the field, for as long as this card remains face-up on the field.''',
    '''FLIP: Take control of 1 WIND monster on your opponent's side of the field, for as long as this card remains face-up on the field.''',
    '''If all @5"Batteryman AA"@7(s) on your side of the field are in Attack Position, increase the ATK of this card by 1000 points for each @5"Batteryman AA"@7 on your side of the field. If all @5"Batteryman AA"@7(s) on your side of the field are in Defense Position, increase the DEF of this card by 1000 points for each @5"Batteryman AA"@7 on your side of the field.''',
    '''As long as this card remains face-up on the field, any damage by a card effect to the controller of this card becomes 0.''',
    '''The original ATK of this card becomes the number of @5"King of the Skull Servants"@7 and @5"Skull Servant"@7 cards in your Graveyard x 1000 points. When this card is destroyed and sent to the Graveyard as a result of battle, remove from play 1 other @5"King of the Skull Servants"@7 or @5"Skull Servant"@7 card in your Graveyard to Special Summon this card.''',
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"Final Ritual of the Ancients"@7. Discard 1 Spell Card from your hand. Take control of 1 monster on your opponent's side of the field until the End Phase. You can only use this effect once per turn.''',
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"Doriado's Blessing"@7. The Attribute of this card is also treated as WIND, WATER, FIRE, and EARTH.''',
    '''@5"Elemental Hero Avian"@7 + @5"Elemental Hero Burstinatrix"@7 This monster cannot be Special Summoned except by Fusion Summon. When this card destroys a monster as a result of battle and sends it to the Graveyard, inflict damage to your opponent's Life Points equal to the ATK of the destroyed monster.''',
    '''@5"Elemental Hero Sparkman"@7 + @5"Elemental Hero Clayman"@7 This monster cannot be Special Summoned except by Fusion Summon. By discarding 1 card from your hand, select and destroy 1 face-up monster on the field with an original ATK that is less than the ATK of this card. You can only use this effect once per turn, during your Main Phase.''',
    ...
    '''Pay 500 Life Points. Special Summon 1 monster from your Graveyard that includes @5"Batteryman"@7 in its card name.''',
    '''You can only activate this card if there is at least 1 face-up @5"Chu-Ske the Mouse Fighter"@7, @5"Monk Fighter"@7, or @5"Master Monk"@7 on your side of the field. Destroy the monster(s) that battle with these monsters on your side of the field this turn, at the end of each Damage Step.''',
    '''This card is used to Ritual Summon @5"Elemental Mistress Doriado"@7. You must also Tribute monsters whose total Levels equal 3 or more from the field or your hand.''',
    '''This card is used to Ritual Summon @5"Reshef the Dark Being"@7. You must also Tribute monsters whose total Levels equal 8 or more from the field or your hand.''',
    '''You can only equip this card to @5"Chu-Ske the Mouse Fighter"@7, @5"Monk Fighter"@7, or @5"Master Monk"@7. When the equipped monster destroys your opponent's monster and sends it to the Graveyard as a result of battle, inflict damage to your opponent's Life Points equal to the DEF of the destroyed monster.''',
    ...
    '''You can only activate this card when a monster on your side of the field is destroyed as a result of battle and sent to the Graveyard. Special Summon 1 Level 4 or lower monster from your hand or Deck that includes @5"Elemental Hero"@7 in its card name.''',
    ...
    '''Inflict 1000 points of damage to your opponent's Life Points for each face-up @5"Mine Golem"@7 on your side of the field. After that, destroy all face-up @5"Mine Golem"@7(s) on your side of the field.''',
    '''Inflict 1000 points of damage to the Life Points of the player who destroyed this Set card.''',
    '''You can only activate this card when a Fusion Monster is Special Summoned. Return all face-up Fusion Monsters on the field to their respective Fusion Decks.''',
    ...
    '''You can only activate this card when a Token(s) is Special Summoned. Destroy all Tokens on the field, and inflict 300 points of damage to your opponent's Life Points for each destroyed Token.''',
    '''You can only activate this card when your opponent activates a Continuous Spell Card. Negate the activation and the effect of the card and destroy it.''',
    ...
    '''This card cannot be Special Summoned. When this card is Tribute Summoned successfully, you can remove from play up to 5 Fire monsters in your Graveyard. Destroy a number of Spell or Trap Cards equal to the number of the cards that you remove from play by this effect.''',
    '''A monster that this card destroys as a result of battle is removed from play.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 1 @5"Levia-Dragon - Daedalus"@7 on your side of the field. Send @5"Umi"@7 on your side of the field to the Graveyard to send all cards in both players' hands and on the field to the Graveyard, except this card.''',
    '''The most lovable and friendly of all the Vehicroids. It can arm itself with training wheels!''',
    '''Pick up and look at 1 Set card on your opponent's side of the field, then return it to its original position. You can only activate this effect once per turn, during your Main Phase.''',
    ...
    '''When this card is destroyed as a result of battle and sent to the Graveyard, you can Special Summon from your Deck 1 Machine-Type monster with an ATK of 1500 or less in face-up Attack Position. Then shuffle your Deck.''',
    ...
    '''When this card is destroyed as a result of battle and sent to the Graveyard, add from your Graveyard to your hand 1 card that includes @5"Elemental Hero"@7 in its card name, and 1 @5"Polymerization"@7.''',
    ...
    '''@5"Gyroid"@7 + @5"Steamroid"@7''',
    '''@5"UFOroid"@7 + @51 Warrior-Type monster@7 A Fusion Summon of this card can only be conducted with the above Fusion Material Monsters. The original ATK and DEF of this card become equal to the combined original ATK of the 2 Fusion Material monsters you used for the Fusion Summon of this card.''',
    '''@5"Cyber Dragon"@7 + @5"Cyber Dragon"@7 A Fusion Summon of this card can only be conducted with the above Fusion Material Monsters. This card can attack twice during the same Battle Phase.''',
    '''@5"Cyber Dragon"@7 + @5"Cyber Dragon"@7 + @5"Cyber Dragon"@7 A Fusion Summon of this card can only be conducted with the above Fusion Material Monsters. During battle between this card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    ...
    '''When a monster that includes @5"Elemental Hero"@7 in its card name attacks, if its ATK is lower than the ATK of the attack target, increase the ATK of the attacking monster by 1000 points during damage calculation only.''',
    '''This card cannot be given as a Tribute. When this card is successfully Summoned or Flip Summoned, it appears on the Field in Defense Position. By discarding one Spell Card from your Hand you can Special Summon one Level 4 Monster Card from your Deck. The Monster Card Special Summoned using this effect cannot attack for the duration of the turn. You can only activate the effect of this card once each turn, during your Main Phase.''',
    '''This card cannot be Special Summoned. It can only be Summoned by giving 3 Monster Cards on your Field as Tributes. While this card remains on the Field in face-up position the ATK and DEF of all other Monster Cards on the Field are reduced by half.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Transcendent Wings"@7. By Tributing this face-up card on your side of the field, destroy all face-up Attack Position monsters on your opponent's side of the field and inflict damage to your opponent's Life Points equal to the combined original ATK of those destroyed monster(s). You can only activate this effect during your opponent's Battle Phase.''',
    '''Send to the Graveyard 1 @5"Winged Kuriboh"@7 from your side of the field and 2 cards from your hand. Special Summon 1 @5"Winged Kuriboh LV10"@7 from your hand or Deck.''',
    '''You can only activate this card when there is a face-up @5"Elemental Hero Bubbleman"@7 on the field. Change 1 @5"Elemental Hero Bubbleman"@7 in face-up Attack Position on your side of the field and 1 monster in face-up Attack Position on your opponent's side of the field to Defense Position. Tribute the @5"Elemental Hero Bubbleman"@7 that was changed to Defense Position and Special Summon 1 monster from your hand that includes @5"Elemental Hero"@7 in its card name.''',
    '''You can only equip this card to @5"Elemental Hero Sparkman"@7. During the Main Phase of your turn, you can change the battle position of 1 face-up monster. After you use this effect 3 times, destroy this card.''',
    '''This card can be Special Summoned from your Hand after you have cancelled the effects of a card controlled by your opponent using a Counter Trap Card. When this card is successfully Special Summoned in this way, the following effects are activated, depending on the cards whose effects were originally cancelled. @4 @7Spell : reduce your opponent's Life Points by 1500. @4 @7Trap : choose one card on your opponent's Field and destroy it. @4 @7Effect Monster : choose one card from your Graveyard and Special Summon it to your Field.''',
    ...
    '''If there is no face-up @5"Kozaky"@7 on the field, destroy this card. If this face-up card on the field is destroyed, inflict damage to the current controller's Life Points equal to the original ATK of this card.''',
    '''If this card attacks, it is changed to Defense Position at the end of the Battle Phase. This card's battle position cannot be changed until the end of your next turn, except with a card effect.''',
    '''Once per turn, during your Main Phase, if you control this card on the field, you can equip it to your @5"Indomitable Fighter Lei Lei"@7 as an Equip Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, you can change the equipped monster's battle position once per turn. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''Once per turn, during your Main Phase, if you control this card on the field, you can equip it to your @5"Soitsu"@7 as an Equip Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, increase the ATK of the equipped monster by 2500 points. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''When this card is Tribute Summoned successfully, you can Special Summon @5"Des Frog"@7(s) from your hand or Deck up to the same number of @5"T.A.D.P.O.L.E."@7(s) in your Graveyard.''',
    '''When this card on your side of the field is destroyed as a result of battle and sent to your Graveyard, you can add any @5"T.A.D.P.O.L.E."@7(s) from your Deck to your hand. Then shuffle your Deck.''',
    ...
    '''If all @5"Batteryman C"@7(s) on your side of the field are in Attack Position, increase the ATK of all Machine-Type monsters on your side of the field by 500 points for each @5"Batteryman C"@7 on your side of the field. If all @5"Batteryman C"@7(s) on your side of the field are in Defense Position, increase the DEF of all Machine-Type monsters on your side of the field by 500 points for each @5"Batteryman C"@7 on your side of the field.''',
    ...
    '''Add 1 @5"Polymerization"@7, and 1 Fusion Material Monster that was used for a Fusion Summon, from your Graveyard to your hand.''',
    '''Remove from play, from your side of the field or your Graveyard, Fusion Material Monsters that are listed on a Fusion Monster Card that includes @5"Elemental Hero"@7 in its card name, and Special Summon that Fusion Monster from your Fusion Deck. (This Special Summon is treated as a Fusion Summon).''',
    ...
    '''You can only activate this card when there are 3 face-up @5"Des Frog"@7 on your side of the field. Destroy all cards on your opponent's side of the field.''',
    ...
    '''Select 1 face-up monster on your opponent's side of the field. Special Summon from your hand 1 monster that has the same Level as the selected monster.''',
    ...
    '''Each time your opponent declares an attack on a face-up Defense Position monster, toss a coin and call it. If you call it right, change the targeted face-up Defense Position monster to Attack Position. If you call it wrong, the controller of this card takes damage equal to the difference between the ATK of the attacking monster and the DEF of the attacked monster.''',
    '''By paying 1000 Life Points you can destroy all Monster cards in face-up position on the Field and prevent any cards of the same type from being Summoned, Flip Summoned, or Special Summoned.''',
    '''@5"Queen's Knight"@7 + @5"Jack's Knight"@7 + @5"King's Knight"@7 A Fusion Summon of this card can only be conducted with the above Fusion Material Monsters. While this card remains on the Field in face-up position, you can cancel the effect of Spell, Trap, and Effect Monster Cards by discarding a card of the same type from your Hand (any Monster Card can be discarded to cancel the effect of an Effect Monster Card). This effect can only be used once per turn.''',
    '''This card cannot be Special Summoned. When this card is Normal Summoned, you can equip as many Equip Spell Cards from your Graveyard as possible to Warrior-Type monster(s) on your side of the field.''',
    '''When this card is destroyed as a result of battle and sent to the Graveyard, you can Special Summon 1 EARTH Warrior-Type monster with an ATK of 1500 or less in face-up Attack Position from your Deck to your side of the field. Then shuffle your Deck.''',
    ...
    '''@5"Elemental Hero Flame Wingman"@7 + @5"Elemental Hero Sparkman"@7 This monster cannot be Special Summoned except by Fusion Summon. Increase the ATK of this card by 300 points for each card in your Graveyard that includes @5"Elemental Hero"@7 in its card name. When this card destroys a monster as a result of battle and sends it to the Graveyard, inflict damage to your opponent's Life Points equal to the ATK of the destroyed monster.''',
    '''Your opponent draws 2 cards. Special Summon 1 monster from your Graveyard that includes @5"LV"@7 in its card name, ignoring the Summoning conditions. The monster that was Special Summoned by this effect cannot attack, nor activate or apply its effect this turn.''',
    '''Select 1 face-up @5"Ojama King"@7 on the field. Destroy all monster(s) on the field that include @5"Ojama"@7 in their card name, except the selected @5"Ojama King"@7. Increase the ATK of the selected @5"Ojama King"@7 by 1000 points for each destroyed monster.''',
    '''When this card is sent from the hand or the field to the Graveyard, add 1 each of @5"Ojama Green"@7, @5"Ojama Yellow"@7 and @5"Ojama Black"@7 from your Deck to your hand.''',
    ...
    '''While you have no cards in your hand, this card is not destroyed as a result of battle while in Attack Position. (Damage calculation is applied normally.)''',
    '''Once per turn, during your Main Phase, if you control this card on the field, you can equip it to your @5"V-Tiger Jet"@7 as an Equip Card, OR unequip the Union equipment and Special Summon this card in face-up Attack Position. While equipped to a monster by this card's effect, increase the ATK and DEF of the equipped monster by 400 points. (1 monster can only be equipped with 1 Union Monster at a time. If the equipped monster is destroyed as a result of battle, destroy this card instead.)''',
    '''During battle between this attacking card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''This card is unaffected by the effects of Trap Cards.''',
    '''When this card destroys an opponent's monster as a result of battle and sends it to the Graveyard, you can Special Summon 1 @5"Hydrogeddon"@7 from your Deck.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Bonding - H2O"@7. While this card is face-up on the field, the ATK of FIRE monsters and Pyro-Type monsters become 0. When this card is destroyed and sent to the Graveyard, you can Special Summon 2 @5"Hydrogeddon"@7s and 1 @5"Oxygeddon"@7 from your Graveyard.''',
    '''If this card attacks your opponent's Life Points directly, increase the ATK of this card by 500 points during the Damage Step only.''',
    '''@5"V-Tiger Jet"@7 + @5"W-Wing Catapult"@7 This card can only be Special Summoned from your Fusion Deck by removing from play the above cards on your side of the field. (You do not use @5"Polymerization"@7). By discarding 1 card from your hand, change the battle position of 1 monster on your opponent's side of the field. (Flip Effects are not activated at this time.)''',
    '''@5"VW-Tiger Catapult"@7 + @5"XYZ-Dragon Cannon"@7 This card can only be Special Summoned from your Fusion Deck by removing from play the above cards on your side of the field. (You do not use @5"Polymerization"@7). Once per turn, remove from play 1 card on your opponent's side of the field. When this card attacks, you can change the battle position of the attack-target monster. (Flip Effects are not activated at this time.)''',
    '''@5"Etoile Cyber"@7 + @5"Blade Skater"@7 A Fusion Summon of this card can only be conducted with the above Fusion Material Monsters. While your opponent controls only 1 monster, this card is not destroyed as a result of battle. While your opponent controls only 2 monsters, double the ATK of this card. While your opponent controls only 3 monsters, this card negates the effects of your opponent's Spell, Trap, and Effect Monster Cards.''',
    '''@5"Elemental Hero Clayman"@7 + @5"Elemental Hero Burstinatrix"@7 This monster cannot be Special Summoned except by Fusion Summon. While this card is in face-up Defense Position, this card can attack your opponent's Life Points directly. In that case, apply half the ATK of this card for damage calculation.''',
    '''@5"Elemental Hero Avian"@7 + @5"Elemental Hero Sparkman"@7 + @5"Elemental Hero Bubbleman"@7 This monster cannot be Special Summoned except by Fusion Summon. By sending 1 card (except this card) from your side of the field to the Graveyard, select 1 monster on your side of the field. While this card is face-up on the field, the selected monster is not destroyed as a result of battle. (Damage calculation is applied normally.)''',
    '''@5"Elemental Hero Wildheart"@7 + @5"Elemental Hero Bladedge"@7 This monster cannot be Special Summoned except by Fusion Summon. This card can attack all monsters on your opponent's side of the field once each.''',
    '''Increase the ATK of the equipped monster by 800 points for each other face-up monster on the field with the same name as the equipped monster.''',
    '''Select 1 face-up @5"Elemental Hero Avian"@7 on your side of the field to activate this card. This turn, the selected card can attack as many times as the number of monster(s) on your side of the field when this card resolves. In that case, it cannot attack your opponent's Life Points directly, and your other monster(s) cannot attack.''',
    '''Tribute 2 @5"Hydrogeddon"@7s and 1 @5"Oxygeddon"@7 on your side of the field. Special Summon 1 @5"Water Dragon"@7 from your hand, Deck or Graveyard.''',
    ...
    '''If there is a face-up monster on your side of the field that includes @5"Elemental Hero"@7 in its card name, negate 1 attack from your opponent's monster.''',
    '''You can only activate this card if there is a face-up @5"Elemental Hero Avian"@7 on your side of the field. Negate the activation of a Spell or Trap Card and destroy it.''',
    ...
    '''If this card attacks a face-up Level 3 or lower monster, destroy the monster with this card's effect without applying damage calculation.''',
    ...
    '''When this card is destroyed as a result of battle and sent to the Graveyard, add 1 Level 4 or lower monster that includes @5"Dark World"@7 in its card name from your Deck to your hand.''',
    '''By sending 1 @5"Aussa the Earth Charmer"@7 and 1 EARTH monster from your side of the field to the Graveyard, you can Special Summon this card from your hand or Deck. If you Special Summon this card in this way, this card gets the following effect: During battle between this attacking card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''By sending 1 @5"Eria the Water Charmer"@7 and 1 WATER monster from your side of the field to the Graveyard, you can Special Summon this card from your hand or Deck. If you Special Summon this card in this way, this card gets the following effect: During battle between this attacking card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''By sending 1 @5"Hiita the Fire Charmer"@7 and 1 FIRE monster from your side of the field to the Graveyard, you can Special Summon this card from your hand or Deck. If you Special Summon this card in this way, this card gets the following effect: During battle between this attacking card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''By sending 1 @5"Wynn the Wind Charmer"@7 and 1 WIND monster from your side of the field to the Graveyard, you can Special Summon this card from your hand or Deck. If you Special Summon this card in this way, this card gets the following effect: During battle between this attacking card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    ...
    '''The controller of this card cannot Normal Summon or Set. During the End Phase of the turn that a monster on your side of the field that includes @5"B.E.S."@7 in its card name, or is named @5"Big Core"@7, is destroyed and sent to the Graveyard, you can Special Summon from your Deck 1 monster that includes @5"B.E.S."@7 in its card name, or is named @5"Big Core"@7.''',
    '''If you activate this card, you cannot Normal Summon, Flip Summon or Special Summon during the turn this card is activated. Special Summon from your Graveyard 1 monster that includes @5"Dark World"@7 in its card name.''',
    '''Return 2 monsters from your Graveyard to your hand that include @5"Dark World"@7 in their card names.''',
    '''You can only activate this card by paying 1000 Life Points when your opponent activates a Normal Spell Card. The effect of the Normal Spell Card that your opponent activated at that time becomes @5"Your opponent discards 1 random card from their hand"@7.''',
    '''Each player sends the top card from their Deck to the Graveyard.''',
    '''Pay 500 Life Points. Destroy all Level 3 monsters in face-up Attack Position on the field.''',
    ...
    '''While this card is in the Graveyard, you can Summon any @5"Elemental Hero"@7 card without giving a card as a Tribute. This effect can only be used once while the card remains in the Graveyard.''',
    '''After activation, this card becomes an Equip Card and can be equipped to any Warrior card with an ATK of 1500 or less. Monster Cards owned by your opponent with an ATK of 1900 or more cannot attack the Monster to which this card is equipped.''',
    '''@5"Elemental Hero Bubbleman"@7 + @5"Elemental Hero Clayman"@7 This monster cannot be Special Summoned except by Fusion Summon.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 1 @5"Dark Magician"@7 on your side of the field. While this card is face-up on the field, inflict 1000 points of damage to your opponent's Life Points each time either player activates 1 Normal Spell Card.''',
    ...
    '''@5"Elemental Hero Burstinatrix"@7 + @5"Elemental Hero Bubbleman"@7 This monster cannot be Special Summoned except by Fusion Summon. When this card destroys a monster as a result of battle and sends it to the Graveyard, increase your Life Points by the ATK of the destroyed monster.''',
    '''You can only activate this card while there is a face-up @5"Elemental Hero Burstinatrix"@7 on your side of the field. Return to the owner's hand(s) all monster(s) on the field that include @5"Elemental Hero"@7 in their card name, except @5"Elemental Hero Burstinatrix"@7.''',
    '''You can only equip this card to @5"Elemental Hero Bubbleman"@7. Increase the ATK of the equipped monster by 800 points. If the equipped monster would be destroyed as a result of battle, destroy this card instead, and make the Battle Damage to the controller of the equipped monster 0.''',
    '''You can only activate this card while there is a face-up @5"Elemental Hero Bubbleman"@7 on your side of the field. During this turn, you can activate 1 Trap Card from your hand.''',
    '''You can only activate this card when an @5"Elemental Hero Clayman"@7 on your side of the field is selected as an attack target. (If it is face-down, pick up and show the card to your opponent.) Destroy the attacking monster and the selected @5"Elemental Hero Clayman"@7 to inflict 800 points of damage to your opponent's Life Points.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 1 @5"Armed Dragon LV7"@7 on your side of the field. By sending 1 card from your hand to the Graveyard, destroy all face-up monsters on your opponent's side of the field.''',
    ...
    '''During battle between this attacking card and a Defense Position monster whose DEF is lower than the ATK of this card, inflict the difference as Battle Damage to your opponent's Life Points.''',
    '''While this card is equipped to a Monster Card, that Monster Card cannot be destroyed in battle. (Damage calculation is still applied.)''',
    '''If this card attacks, it is changed to Defense Position at the end of the Damage Step.''',
    '''When this card is Summoned or Special Summoned successfully, you can choose up to 5 Spell Cards from your opponent's Graveyard and remove them from the game. For each card removed using this effect, the ATK of this card increases by 300 points.''',
    ...
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by Tributing 3 Fiend-Type monsters on your side of the field. Each time your opponent Normal Summons a monster(s), Special Summon 1 @5"Phantasm Token"@7 (Fiend-Type/DARK/Level 1/ATK 1000/DEF 1000) on your side of the field. This token cannot declare an attack. Once per turn, by Tributing 1 monster on your side of the field, increase the ATK of this card by the original ATK of the Tributed monster, until the End Phase of this turn.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by sending @5"Elemental Hero Bubbleman"@7 on your side of the field and @5"Metamorphosis"@7 in your hand to the Graveyard. This card's name is treated as @5"Elemental Hero Bubbleman"@7 while it is face-up on the field. Destroy an opponent's monster that battles this card at the end of the Damage Step.''',
    '''When this card is Special Summoned, you can Special Summon any number of @5"Hero Kid"@7(s) from your Deck.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Attack Reflector Unit"@7. Once per turn, while this card is in Attack Position, negate your opponent's first attack.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Photon Generator Unit"@7. You can destroy 1 monster with ATK or DEF equal to or higher than the ATK of this card. You can only use this effect once per turn.''',
    '''While an @5"Ancient Gear"@7 is face-up on your side of the field, you can Special Summon this card from your hand in Attack Position.''',
    '''Select 1 face-up monster on your side of the field that includes @5"Elemental Hero"@7 in its card name to activate this card. This turn, the ATK of the selected monster is halved and it can attack twice during the same Battle Phase.''',
    '''Special Summon 1 Level 2 or lower Machine-Type monster from your hand.''',
    '''You can only activate this card by discarding 1 card from your hand while a monster that includes @5"Ancient Gear"@7 in its card name is face-up on your side of the field. Select 1 Spell Card from your Deck and Set it on your side of the field. You cannot use that Spell Card this turn.''',
    '''You can only activate this card while you have 2 or more cards in your hand, and have either @5"Uria, Lord of Searing Flames"@7 or @5"Hamon, Lord of Striking Thunder"@7 face-up on your side of the field. By sending your entire hand to the Graveyard, Special Summon 3 @5"Phantasmal Martyr Tokens"@7 (Fiend-Type/DARK/Level 1/ATK 0/DEF 0) in Attack Position on your side of the field.''',
    '''You can only equip this card to @5"Elemental Hero Wildheart"@7. Increase the ATK of the equipped monster by 500 points. When the equipped monster is destroyed by a card effect and sent to the Graveyard, destroy all Spell and Trap Cards on the field. Inflict 100 points of damage to your opponent's Life Points for each Spell or Trap Card destroyed by this effect.''',
    '''Tribute 2 @5"Cyber Dragon"@7s on your side of the field to activate this card. Special Summon 1 @5"Cyber Laser Dragon"@7 from your hand, Deck, or Graveyard.''',
    '''Increase the ATK of each face-up monster on the field that includes @5"Ancient Gear"@7 in its card name by 300 points. Each time a monster(s) is Normal Summoned, put 1 counter on this card. If you Tribute Summon a monster that includes @5"Ancient Gear"@7 in its card name, you can substitute this card for a Tribute(s), if the number of counters is equal to or greater than the number of required Tribute(s).''',
    '''Decrease the ATK of 1 of your opponent's monsters by 400 points for each @5"Hero Kid"@7 in your Graveyard, until the End Phase.''',
    '''Tribute 1 @5"Cyber Dragon"@7 on your side of the field to activate this card. Special Summon 1 @5"Cyber Barrier Dragon"@7 from your hand or Deck.''',
    '''You can only activate this card by discarding 1 card from your hand when you take Battle Damage to your Life Points. Special Summon 1 monster from your Deck with ATK equal to or less than the Battle Damage you took, in Attack Position.''',
    '''By Tributing this card, inflict 500 points of damage to your opponent's Life Points, and then neither player can activate Trap Cards during the Battle Phase of this turn.''',
    '''This card's name is treated as @5"Cyber Dragon"@7 while it is face-up on the field.''',
    '''If your opponent's monster attacks this face-down Defense Position card, this card becomes an Equip Card equipped to the attacking monster, without applying damage calculation. Destroy the equipped monster during the Standby Phase of your opponent's next turn.''',
    '''Increase the ATK and DEF of this card by 100 points for each Machine-Type monster on the field other than this card.''',
    ...
    '''When this card is Normal Summoned, control of this card shifts to your opponent. During each player's End Phase, your opponent selects 1 card from the Graveyard of this card's controller and removes it from play.''',
    '''In addition to a normal attack, this card can attack during the same Battle Phase as many times as the number of @5"Chain Thrasher"@7(s) in your Graveyard.''',
    '''When this card is Normal Summoned, Flip Summoned, or Special Summoned, declare different Monster Card Attributes equal to the number of @5"Disciple of the Forbidden Spell"@7(s) in your Graveyard. If this card attacks a monster that has a declared Attribute, destroy the monster without applying damage calculation.''',
    '''This card is unaffected by the effects of Trap Cards.''',
    '''The ATK and DEF of this card are equal to the number of Tokens on the field x 500 points.''',
    '''When this card is destroyed as a result of battle and sent to the Graveyard, add 1 Insect-Type monster with an ATK of 1500 or less from your Deck to your hand.''',
    '''This card is changed to Defense Position when it is Normal Summoned or Flip Summoned. While this card is face-up on the field, negate the effects of all Continuous Spell Cards and Continuous Trap Cards.''',
    ...
    '''If this card is in your Graveyard during your Standby Phase and there are no Spell or Trap Cards on your side of the field, you can Special Summon this card to your side of the field. This effect cannot be activated if there is a face-up @5"Treeborn Frog"@7 on your side of the field.''',
    '''Increase the ATK of this card by 300 points for each @5"T.A.D.P.O.L.E."@7 in your Graveyard.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Trial of the Princesses"@7. During your Standby Phase, increase your Life Points by 800 points for each monster on your side of the field.''',
    '''This card cannot be Normal Summoned or Set. This card cannot be Special Summoned except by the effect of @5"Trial of the Princesses"@7. During your Standby Phase, inflict 600 points of damage to your opponent's Life Points for each monster on your opponent's side of the field.''',
    ...
    '''While this card is face-up on the field, during your opponent's Standby Phase, send a number of cards from the top of your opponent's Deck to the Graveyard equal to the number of @5"Malice Ascendant"@7(s) in your Graveyard.''',
    '''Increase the ATK of this card by 500 points for each @5"Grass Phantom"@7 in your Graveyard.''',
    ...
    '''When this card is Normal Summoned, it gets 1 of the following effects for each @5"Divine Dragon - Excelion"@7 in your Graveyard when this effect resolves (your choice). These effects cannot accumulate. @4 @7Increase the ATK of this card by 1000 points. @4 @7If this card destroys your opponent's monster as a result of battle, it can attack once again in a row. @4 @7When this card destroys a monster as a result of battle and sends it to the Graveyard, inflict damage to your opponent's Life Points equal to the ATK of the destroyed monster.''',
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"End of the World"@7. If this card destroys your opponent's monster as a result of battle, it can attack once again in a row.''',
    '''This card can only be Ritual Summoned with the Ritual Spell Card, @5"End of the World"@7. By paying 2000 Life Points, destroy all cards on the field.''',
    '''@5"Des Frog"@7 + @5"Des Frog"@7 + @5"Des Frog"@7 A Fusion Summon of this card can only be conducted with the above Fusion Material Monsters. Increase the ATK of this card by 500 points for each @5"Treeborn Frog"@7 in your Graveyard.''',
    '''You can only activate this card while there are 3 monster cards with the same name in your Graveyard. Select 1 of those monsters, Special Summon it to your side of the field, and equip it with this card. When this card is destroyed, destroy the equipped monster.''',
    '''You can only equip this card to @5"White Magician Pikeru"@7 or @5"Ebon Magician Curran"@7. Increase the ATK of the equipped monster by 800 points. During a turn that the equipped monster destroyed a Level 5 or higher monster as a result of battle, by Tributing the equipped monster and this card, Special Summon from your hand or Deck: 1 @5"Princess Pikeru"@7 if you Tributed @5"White Magician Pikeru"@7, or 1 @5"Princess Curran"@7 if you Tributed @5"Ebon Magician Curran"@7.''',
    '''This card can be used to Ritual Summon @5"Ruin, Queen of Oblivion"@7 or @5"Demise, King of Armageddon"@7. You must also Tribute monsters from the field or your hand whose total Levels equal the Level of the Ritual Monster you are attempting to Ritual Summon.''',
    ...
    '''Discard 1 card from your hand. Remove from play 1 face-up monster on your opponent's side of the field. If there is a card(s) in your opponent's Graveyard with the same name as the removed monster, also remove from play that card(s).''',
    '''Select 1 face-up monster on your side of the field. Send 1 card from your Deck to the Graveyard with the same name as the selected card.''',
    '''Destroy 1 face-up monster on your side of the field. Add 1 card from your Deck to your hand with the same name as the destroyed card.''',
    '''After the activation of this card, send your entire hand to the Graveyard. Inflict 200 points of damage to your opponent's Life Points for each card you sent to the Graveyard by this effect.''',
    '''Send 2 random Fusion Monsters from your opponent's Fusion Deck to the Graveyard.''',
    '''You can only activate this card when a monster on your side of the field is destroyed as a result of battle and sent to the Graveyard. Increase your Life Points by the original ATK of the destroyed monster.''',
    ...
    '''You can add one @5"Kuriboh"@7 or @5"Winged Kuriboh"@7 to your Hand or Special Summon them to your Field from your Deck.''',
    '''@5"Elemental Hero Avian"@7 + @5"Elemental Hero Burstinatrix"@7 + @5"Elemental Hero Clayman"@7 + @5"Elemental Hero Bubbleman"@7 This monster cannot be Special Summoned except by Fusion Summon. The Attribute of this card is also treated as WIND, WATER, FIRE, and EARTH. When this card are successfully Fusion Summoned, all cards that have been removed from the game are returned to their owner's Deck and the Deck is shuffled. For each Monster Card with the same attribute as this card on your opponent's Field, the ATK of this card increases by 300 points.''',
    '''This card cannot be Normal Summoned. It can only be Special Summoned when 1 card on your field with @5"Sphinx"@7 in its name is used as a Tribute. As long as this card is face-up on the field, each time an EARTH monster is successfully Flip Summoned, 1000 points of damage will be inflicted to your opponent's Life Points.''',
    '''You can flip this card into face-down Defense Position once per turn during your Main Phase. When this card is Flip Summoned successfully, you can switch the original ATK with the original DEF of 1 face-up EARTH monster on the field until the End Phase.''',
    '''If a Rock-Type monster in Defense Position is attacked, damage taken by the attacking monster's controller is doubled.''',
    '''The ATK and DEF of this card increase by the total of the number of your cards removed from the game x 300.''',
    '''The ATK and DEF of this card increase by the total of the number of Monster Cards removed from the game x 100.''',
    '''This card can be Tribute Summoned by giving one @5"The Ancient Sun Helios"@7 card from your Field as a Tribute. The ATK and DEF of this card are equal to the total of the number of Monster Cards that have been removed from the game x 200. If this card is destroyed in battle and sent to the Graveyard, it is automatically Special Summoned in the End Phase and its ATK/DEF increase by 300 points.''',
    '''This card can be Tribute Summoned by giving one @5"Helios Duo Megiste"@7 card from your Field as a Tribute. The ATK and DEF of this card are equal to the total of the number of Monster Cards that have been removed from the game x 300. If this card is destroyed in battle and sent to the Graveyard, it is automatically Special Summoned in the End Phase and its ATK/DEF increase by 500 points. If your opponent has Monster Cards on the Field at the time, this card can attack them once more.''',
    '''A brand-new Elemental Hero from Neospatian. It exerts an unknown power when Contact Fused with Neospatian.''',
    '''When this card is sent to the Graveyard, Special Summon 2 @5"Fluffy Tokens"@7 (Plant-Type/WIND/1 STAR/ATK 0/DEF 0) to your side of the field. This Token cannot be used as a Tribute for a Tribute Summon during the turn it is Special Summoned.''',
    '''Special Summon with the effect of @5"Insect Queen"@7.''',
    '''Special Summon with the effect of @5"Multiply"@7. This Token cannot be used as a Tribute for a Tribute Summon.''',
    '''Special Summon with the effect of @5"Scapegoat"@7. This Token cannot be used as a Tribute for a Tribute Summon.''',
    '''Special Summon with the effect of @5"Multiplication of Ants"@7. This Token cannot be used as a Tribute for a Tribute Summon.''',
    '''Special Summon with the effect of @5"Jam Breeding Machine"@7.''',
    '''Special Summon with the effect of @5"Statue of the Wicked"@7.''',
    '''Special Summon with the effect of @5"Cobra Jar"@7. When this Token is destroyed as a result of battle, inflict 500 points of damage to your opponent's Life Points.''',
    '''Special Summon with the effect of @5"Lekunga"@7.''',
    '''Special Summon with the effect of @5"Des Dendle"@7.''',
    '''Special Summon with the effect of @5"Fiend's Sanctuary"@7. This Token cannot attack. Excess damage against the Controller from battle with this Token is received by your opponent instead. Pay 1000 Life Points during your Standby Phase. If you do not pay 1000 Life Points, this Token is destroyed.''',
    '''Special Summon with the effect of @5"Ojama Trio"@7. This Token cannot be used as a Tribute for a Tribute Summon. When it is destroyed, the controller will take 300 points of damage to their Life Points.''',
    '''Special Summon with the effect of @5"Stray Lambs"@7.''',
    '''Special Summon with the effect of @5"Tricky's Magic 4"@7. This Token cannot declare an attack.''',
    '''Special Summon with the effect of @5"The Blockman"@7. This Token cannot declare an attack.''',
    '''Special Summon with the effect of @5"Raviel, Lord of Phantasms"@7. This Token cannot declare an attack.''',
    '''Special Summon with the effect of @5"Phantasmal Martyrs"@7.''',
